...
\section{Tipos de Bloqueos en el Protocolo de Herencia de Prioridad}

\subsection{Tipos de Bloqueos}
...
\subsection{Características del Protocolo}
\begin{itemize}
...
\section{Cálculo del Factor de Bloqueo}
...
\section{Protocolos de Techo de Prioridad}

\subsection{Techo de Prioridad de un Recurso}
...
\subsection{Características de los Protocolos de Techo de Prioridad}
\begin{itemize}
...
\section{Protocolo de Techo de Prioridad Inmediato (PPP)}
...
\subsection{Cálculo del Tiempo de Bloqueo}
...
\subsection{Comportamiento con el Protocolo de Techo de Prioridad Inmediato (PPP)}
...
\section{Asignación de Prioridades a las Tareas Aperiódicas}
...
\section{Servicio de Tareas Aperiódicas}

\subsection{Servicio con Tiempo en Segundo Plano}
\begin{itemize}
...
\subsection{Servicio de Aperiódicas con Sondeos}
\begin{itemize}
...
\section{Servidor Diferido}

\subsection{Características del Servidor Diferido}
\begin{itemize}
...
\subsection{Análisis de Planificabilidad con el Servidor Diferido}
...
\subsubsection{Cálculo del Límite Superior de Utilización}
...
\subsubsection{Condición de Planificabilidad}
...
\subsection{Ventajas del Servidor Diferido}
\begin{itemize}
