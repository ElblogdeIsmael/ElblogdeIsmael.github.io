...
\date{\textbf{Asignatura:} Tema 4: Capa de Aplicación (FR)\\[1cm]}
...
\begin{quote}
\texttt{esquema:[//[usuario[:contraseña]@]dominio[:puerto][/ruta][/recurso][?solicitud][\#fragmento]}
\end{quote}
