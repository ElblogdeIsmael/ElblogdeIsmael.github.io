...
\begin{table}[H]
    ...
    \hline
    $39500+29400=68900$& 2113 maquinaria& \\
    \hline
    14469 & 472 HP IVA S& \\
    \hline
    & 572 bancos & 83369\\
...
\begin{itemize}
    ...
    \item Deterioro = 350.000 - 320.000 = 30.000 
\end{itemize}
...
\begin{table}[H]
    ...
    \hline
    2.472.750 - 2.294.000 = 178.750& \benefIM & \\
    \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \VC = 51.000 - 5.100 · $\frac{7}{12}$ -5100 -5100 = 37.825
    \item Deterioro = 36.000 - 37.825 = 1.825
\end{itemize}
...
\begin{table}[H]
    ...
    \hline
    14.025 (contando los dos meses de 2023)& \AAMAQ & \\
    \hline
    (suponemos que cobra la mitad de 40.000) 20.000& \bancos & \\
    \hline
    20.000 + IVA = 28400 (al suponer que antes hemos cobrado la mitad de la cuantía sin el IVA, aquí debemos de incluirlo todo, como no especifica, vale de las dos maneras)& \enajenacion & \\
    \hline
    & \benefIM &3.025(\textit{haciendo la diferencia y anotando lo que falta})\\
    \hline
    & 213 Maquinaria & 51.000\\
    \hline
    & 472 HP IVA r & 8400 = 40.000 · 0,21\\
    \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item En cuanto a la Amortización no nos comenta el enunciado ningún deterior por lo que cada año se amortiza \myequation{60000}{10} = 6.000, como pasan 
\end{itemize}
