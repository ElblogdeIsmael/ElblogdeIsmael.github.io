...
\begin{table}[H]
    ...
    \begin{table}[H]
        ...
        \hline
        $ 1800/6 * 2 = 600 ; 1800-600 = 1200 $ & 752 ingresos por arrendamientos & \\
        \hline
        & 485 ing anticipados & 1200 \\
        \hline
    ...
    \begin{table}[H]
        ...
        \begin{table}[H]
            ...
            \begin{table}[H]
                ...
                \hline
                600 & 752 Ing Arrendamientos & \\
                \hline
                & 610 var existencias& 69,4\\
                \hline
                & 129 rdo del ejercicio & 469,4 \\
                \hline
                \end{tabular}
                \end{table}
...
\begin{table}[H]
    ...
    \textbf{DEBE} & \textbf{Compra de mercaderías} & \textbf{HABER} \\
    \hline
    30000& 600 compra de mercaderías & \\
    \hline
     & 572 bancos & 20000 \\
    \hline
    $30000*0,95*0,21 = 5985$& 472 HP IVA s & \\
    \hline
    15985& 401 proveedores ef comerciales a pagar& \\
    \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \hline
    $166,67 = 2000 * 0,2 / 12 * 5 ^1$& 681 amort eq Informáticos & \\
    \hline
...
\textit{1. Para el cáculo de ese valor se nos dat como información complementaria que siga el método de razón del 20 \% anual y que se ha utilizado durante 5 meses, por lo que el cálculo es de la manera que se especifica.}
...
\begin{table}[H]
    ...
    \hline
    & 490 deterioro op comerciales & \\
    \hline
    & 794 & reversión del deterioro op comerciales\\
    \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{6cm}|p{3cm}|}
    \hline
    \textbf{DEBE} & \textbf{Amortzaciones} & \textbf{HABER} \\
    \hline
...
\end{itemize}
Se ha apreciado el dólar, debemos de dotar diferencias negativas de cambio.

\begin{table}[H]
    \centering
    \begin{tabular}{|p{3cm}|p{6cm}|p{3cm}|}
    \hline
    \textbf{DEBE} & \textbf{Pago a 01/04/2021 de la compra de enero} & \textbf{HABER} \\
    \hline
    $2000 / 1,3$= 1538,46& 600 compra de mercaderias & \\
    \hline
    128,21& 668 dif negativas de cambio & \\
    \hline
    & 572 bancos & $2000*1,2=1666,67$\\
    \hline
    \end{tabular}
    \end{table}
...
\begin{table}[H]
    ...
    \hline
    & 572 bancos & $5000*1,25=6250$\\
    \hline
    6250 & 573 bancos en moneda exranjera & \\
    \hline
    \end{tabular}
    \end{table}
...
\begin{table}[H]
        ...
        \hline
        6179,10 = $\frac{6000 \text{ dólares}}{1,34} * 1,38$ & 573 bancos en moneda extranjera & \\
        \hline
        & 700 venta de mercaderias & 6000 \\
        \hline
        & 768 diferencias positivas de cambio & 179,10 \\
        \hline
        \end{tabular}
        \end{table}

\begin{itemize}
    \item a 31 de diciembre el tipo de cambio es de 0,9 \$/\euro
    \item en la cuenta hay 12429,10 \$, si el tipo de cambio baja quiere decir que el dólar se ha apreciado, por lo que tendríamos $\frac{12429,10}{0,9} = 13810,1 \euro $ 
\end{itemize}
...
\begin{table}[H]
            ...
            \hline
            & 780 diferencias positivas de cambio & $13810,1-12429,10=1381,01$\\
            \hline
            1381,01& 572 bancos & \\
            \hline
            \end{tabular}
