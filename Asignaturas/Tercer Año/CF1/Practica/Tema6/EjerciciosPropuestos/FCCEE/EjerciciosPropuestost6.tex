...
\begin{table}[H]
    ...
    \hline
    $500 (2018)+1500(2019)$& 2801 Amortización acumulada de desarollo& \\
    \hline
    & \bancos & 1.000\\
    \hline
...
Como no ha bastado con el fonde de comercio, debemos de calcular la proporción que asume cada inmovilizado.
\begin{itemize}
...
\begin{table}[H]
    ...
    \hline
    $25277+75833=101110$& 280 Amortización del Inmovilizado Material& \\
    \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    \item Cálculo de la amortziación:
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \textbf{Debemos de revertir 14.000}
            \end{itemize}
        \end{itemize}
    \end{itemize}
\end{itemize}
...
\begin{table}[H]
    ...
    \hline
    14.000& 2906 Deterioro de las AP INF& \\
    \hline
    & 790 Reversión del deterioro inmovilizado intangible & 14.000\\
    \hline
    \end{tabular}
\end{table}

\begin{itemize}
    \item Al reveretir el deterioro tenemos una nueva cuota de amortización 
...
\begin{table}[H]
    ...
    \hline
    4.000 & 2906 Deterioro de las aplicaciones informáticas & \\
    \hline
    13000& 670 Pérdidas procedentes del inmovilzado intangible& \\
    \hline
...
\begin{table}[H]
    ...
    \hline
    13.000 suma total de los valores de la t tabla en la fecha indicada& 201 Desarrollo & \\
    \hline
