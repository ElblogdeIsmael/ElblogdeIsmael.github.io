...
\section{Criterior específicos de reconocimento y valoriación}
...
\subsection{Valoriación Inicial}
...
En todo caso, al menos cada año, deberá de comprobarse la existencia de deteriro en el valor de los inmovilizados intangibles, y si es así, se deberá de reconocer la pérdida por deterioro. Este proceso se realizará como llevamos viendo comparando los valores contables con los valores recuperables.\\
...
\subsection{Concesiones Adeministrativas}
\subsubsection{Concepto}
Mecanismo contractual utilizado por el Estado o entidad de Derecha Público.\\
