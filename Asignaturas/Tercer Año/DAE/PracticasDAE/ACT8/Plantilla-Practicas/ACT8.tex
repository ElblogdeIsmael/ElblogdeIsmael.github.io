...
\begin{itemize}
    ...
    \item 3: Trabaja en correos, es muy nervioso, su hijó le pegó, menciona que va a matar al 8 y algunos de los otros hombres le exponen argumentos negativos.
    \item 4: Dice que el anciano que vió al chico lo vió corriendo hacia la puerta.
    \item 5: Cambia su voto a inocente. 
    \item 6:
    \item 7: Sigue defendiendo que no saben como siguen escuchando al 8. 
    \item 8:
    \item 9:
    \item 10: Posee gran nivel de nerviosismo y le dicen en numerosas ocasiones que se calme,
    \item 11: Les lee unas notas, piensa que el 8 dice unas declaraciones muy coherentes. Posteriormente, cambia su  voto a inocente, le piden justificación y dice que es libre de tener dudas y no tiene porque darle dicha justificación.
    \item 12: Él dice que si el asesinato lo hubiese cometido él, hubiese volvido a por la navaja.
\end{itemize}

\section{Enunciado y Respuestas de la actividad}
