...
% ========================
% \input{paquetes.tex}  % si tienes paquetes personalizados
% \input{comandos.tex}  % comandos LaTeX propios
% \input{estilos.tex}   % estilos de secciones, etc.
...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \node[inner sep=0pt] at (current page.center)
            {\includegraphics[width=\paperwidth,height=\paperheight]{fondo_info.jpg}};
    \end{tikzpicture}
...
Gráfica} \par}
        ...
        % \vspace{1cm}
        % \includegraphics[width=0.25\textwidth]{ugr.png} % opcional: logo
        % \vspace{1cm}
...
\begin{center}
  \href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{\includegraphics[width=0.35\textwidth]{by-nc-nd.png}}
\end{center}
\end{flushleft}
\end{minipage}
};
...
\input{../src/tex/indice_detallado.tex}
\input{../src/tex/ejercicios-parte1}   
\input{../src/tex/ejercicios-parte2}


% \part{Práctica}
% \input{../src/tex/pr1-2-Enunciados}
% \input{../src/tex/pr1-2-Resolución.tex}
% \input{../src/tex/resolucionpr3.tex}
% % Ejercicios adicionales
% \input{../src/tex/ejercicios_adicionales.tex}

\input{referencias.bib}  % si tienes paquetes personalizados
