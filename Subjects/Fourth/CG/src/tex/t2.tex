...
\section{Análisis y estimación de las funciones de coste}

\subsection{Hipotesis de linealidad}
...
\subsubsection{El Intervalo Relevante}
...
\subsubsection{Representación del Modelo Contable}
...
\subsection{Métodos para analizar el comportamiento de los costes}
...
\subsection{Funciones a usar en Excel para la estimación}
...
\subsubsection{Cálculo de Coeficientes de la Función Lineal}
...
\subsubsection{Cálculo del Coeficiente de Determinación}
...
\subsection{Enfoque general para estimar las funciones de coste}
...
\subsubsection{Necesidad de la Estimación}
...
\subsubsection{Consideraciones Clave}
...
\subsection{Pasos en la estimación de una función de coste}
...
\subsection{Método de los valores extremos}
...
\subsubsection{Criterio de Aplicación}
...
\subsubsection{Mecanismo de Cálculo (Ejemplo Implícito)}
