...
\fancyfoot[L]{\normalsize Contabilidad de
Gestión} % pie de página izquierdo con tamaño normal
...
\begin{titlepage}
    ...
    \begin{center}
        ...
        {\Huge \bfseries\scshape\textcolor{white}{Contabilidad de
Gestión} \par}
        \vspace{0.5cm}
...
\begin{center}
    ...
    {\Huge Contabilidad de
Gestión}\\[2cm] % Incrementar el espacio entre líneas
