...
El documento divide este crecimiento en cinco grandes etapas:
...
Le sugiero que preste especial atención, de cara a la evaluación, a la ``Paradoja de la Exportación'' y a la divergencia entre el peso del VAB a precios corrientes y constantes, pues son conceptos fundamentales del análisis sectorial. Que tenga un estudio provechoso.
...
Concluyo recordándole que la interacción entre la pérdida de la política cambiaria, la elasticidad-renta de las importaciones y las recientes mejoras de competitividad-precio vía devaluación interna resultan conceptos nucleares para la asimilación de esta disciplina.
