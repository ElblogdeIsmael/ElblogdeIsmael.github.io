# Test Quizz de Dirección de Operaciones 1

- **Autor:** Ismael Sallami Moreno
- **Titulación:** Doble Grado en Ingeniería Informática y ADE
- **Descripción:** Recopilación de tipo tests realizados en clase.
...
24. El cloud computing o la computación en la nube es un ejemplo claro de innovación incremental que ha cambiado los trabajos en remoto y en no remoto en las empresas, consiguiendo una mayor eficiencia y velocidad en la adopción de nuevo software.
- ( ) Falso  
- ( ) Verdadero  

25. "Meta se hace con la startup PlayAI y acelera las adquisiciones en IA para competir con OpenAI, Alphabet y Elon Musk." (El País, 15/07/2025). La noticia anterior hace referencia a una estrategia de desarrollo externo que busca la adquisición de tecnología o experiencia externa.
- ( ) Falso  
- ( ) Verdadero  

26. Entre los factores del entorno que pueden influir en el éxito del sector de los videojuegos destacan las expectativas de crecimiento del mercado de la realidad virtual y la realidad aumentada, cuyo desarrollo se extiende a ámbitos como la educación o la salud, más allá del propio sector del gaming.
- ( ) Falso  
- ( ) Verdadero  

27. La ingeniería de valor se centra en mejorar el diseño previo a la producción, mientras que el análisis de valor busca la mejora durante el proceso de producción.
- ( ) Falso  
- ( ) Verdadero  

28. El desarrollo de nuevos productos consiste en una secuencia de decisiones que darán lugar a nuevo producto o servicio, cuya fase inicial consiste en elaborar prototipos que nos permitan testar la viabilidad económica, comercial y técnica del futuro producto.
- ( ) Falso  
- ( ) Verdadero  

29. La participación de las distintas funciones empresariales en las distintas etapas del desarrollo de nuevos productos puede adoptar un enfoque secuencial cuando las diferentes áreas funcionales participan en el proceso desde el comienzo de este.
- ( ) Falso  
- ( ) Verdadero  

30. La concreción de una idea de negocio debe cumplir con unos requisitos mínimos de viabilidad en su evaluación. En este sentido, la viabilidad económica considera el estudio del potencial de mercado para conocer las preferencias de los consumidores.
- ( ) Falso  
- ( ) Verdadero  

31. La estrategia de desarrollo interno de nuevos productos y servicios normalmente supone menores costes y riesgos de desarrollo del producto que una estrategia de desarrollo externo.
- ( ) Falso  
- ( ) Verdadero  

32. El diseño robusto consiste en garantizar que las pequeñas variaciones que se produzcan en el proceso de fabricación no afecten al resultado.
- ( ) Falso  
- ( ) Verdadero  

33. El inventario permite acomodar fácilmente los cambios de la demanda en el caso de los servicios.
- ( ) Falso  
- ( ) Verdadero  

34. En la fase de madurez del ciclo de vida del producto, las tasas de crecimiento de las ventas tienden a disminuir con el tiempo, aunque se mantengan positivas hasta cierto punto de la curva.
- ( ) Falso  
- ( ) Verdadero  

35. Los aviones suelen incorporar dos motores aunque solamente necesiten uno para su correcto funcionamiento. Según la terminología empleada en diseño de producto, el uso de motores dobles se considera un elemento redundante para garantizar la fiabilidad del producto.
- ( ) Falso  
- ( ) Verdadero  

36. El modelo de ciclo de vida del producto recomienda comenzar la estandarización del producto en la fase de introducción para reducir los elevados costes de I+D iniciales.
- ( ) Falso  
- ( ) Verdadero  
