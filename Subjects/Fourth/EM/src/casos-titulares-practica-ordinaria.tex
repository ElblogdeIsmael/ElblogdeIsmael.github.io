...
% El texto usa \euro dentro de fórmulas y el paquete no estaba declarado.
\usepackage{eurosym}
...
% El documento usaba el entorno solucion sin definirlo en ninguna parte, así que
% no compilaba. Va en la misma caja que \nota, que es el estilo del fichero.
