...
% El orden sigue el temario de la guía docente de la asignatura (2161143):
% los cuatro primeros temas, los casos y titulares que los acompañan, y el
% tema 5 sobre sistemas monetarios y financieros. El tema 6, crecimiento y
% desarrollo, está por escribir.
\input{../src/t1/t1_diapo.tex}
\input{../src/t2/t2_diapo.tex}
\input{../src/t3/t3_diapo.tex}
\input{../src/t4/t4_diapo.tex}
\input{../src/t5/t5.tex}

% Los casos y titulares van en apéndice y no como capítulo: acompañan a los
% temas 1 a 4 y, puestos en medio, les robaban el número a los temas.
\appendix
\input{../src/casos-titulares-practica.tex}
