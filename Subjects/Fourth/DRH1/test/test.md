# Test DRH1 - Dirección de Recursos Humanos (Ordinaria)

* **Autor:** Ismael Sallami Moreno
* **Descripción:** Banco de preguntas Verdadero/Falso y tipo test del examen ordinario de RRHH, organizado por temas. En cuanto a los quiz, son los mismos que los hechos en clase pero con reformulaciones. Pulsa "Ver explicación" para razonar cada respuesta.
...
5. Actualmente las empresas consideran que los recursos humanos solo actúan ante los estímulos económicos.
    ...
    > Falso. Influyen muchos más factores: retribución indirecta (ambiente o flexibilidad laboral), oportunidades de crecimiento profesional, el propósito de la empresa, etc.
...
7. Los RRHH de una empresa son exclusivamente las personas que pertenecen al departamento de RRHH.
    ...
    > Falso. Los RRHH incluyen a todos los empleados de la organización, no solo al departamento de RRHH.
...
8. Los RRHH son exclusivamente las personas que ocupan el último nivel de la cadena de mando de una organización.
    ...
    > Falso. Son todos los empleados de la organización, no solo los de un nivel concreto.
...
9. Los RRHH son todas las personas que pertenecen a una organización, salvo las que ocupan un puesto directivo.
    ...
    > Falso. Son todos los miembros de la organización, independientemente de su nivel jerárquico (incluidos los directivos).
...
10. La reestructuración organizativa supone una reducción de los niveles jerárquicos.
    ...
    > Verdadero. Es el llamado downsizing (estructuras más planas).
...
11. La reestructuración organizativa supone siempre una reducción del tamaño empresarial.
    ...
    > Falso. Puede conllevar una reducción del tamaño, pero no siempre: cabe cambiar la estructura y el funcionamiento sin reducir el tamaño.
...
12. Para conseguir estructuras más planas en ningún caso se realizarán cambios en el diseño de trabajo.
    ...
    > Falso. Es necesario hacer cambios en el diseño del trabajo o aplanar la estructura organizativa.
...
14. La flexibilidad empresarial se puede lograr, entre otras formas, mediante la centralización, la subcontratación y el uso de nuevas tecnologías.
    ...
    > Falso. Se logra mediante la descentralización (no centralización), la subcontratación y el uso de nuevas tecnologías.
...
15. La descentralización, la subcontratación y el uso de nuevas tecnologías tienen un efecto directo sobre las prácticas de RRHH.
    ...
    > Verdadero. Aportan mayor flexibilidad y son factores organizativos que afectan a las prácticas de RRHH.
...
16. La descentralización tiene un efecto directo sobre las prácticas de RRHH, pero la subcontratación y el uso de nuevas tecnologías no.
    ...
    > Falso. Todas (descentralización, subcontratación y nuevas tecnologías) pueden tener un efecto en las prácticas de RRHH.
...
17. Actualmente el director de RRHH se encarga solo de los aspectos relativos al coste de personal y a la legislación que afecta a los RRHH.
    ...
    > Falso. Hoy tiene un papel mucho más amplio: gestor especializado tanto en aspectos económicos como humanos, que diseña estrategias, políticas y prácticas de gestión.
...
18. Entre las tendencias de la gestión de RRHH se encuentran la gestión de la diversidad, la gestión del talento y el empowerment.
    ...
    > Falso. El empowerment es un factor individual. Las tendencias son gestión de la diversidad, gestión del talento, digitalización de RRHH y liderazgo emocional/employer branding.
...
21. Los objetivos implícitos son los que presentan el alcance estratégico de la gestión de los RRHH.
    ...
    > Falso. El alcance estratégico lo presentan los objetivos a largo plazo (rentabilidad y competitividad, incremento de valor, mejora de eficiencia y eficacia).
...
22. El departamento de RRHH es igual de importante y complejo en todas las organizaciones.
    ...
    > Falso. Cuanto más grande es la empresa, más importante y complejo es; en empresas pequeñas puede no ser necesario.
...
25. Los procesos de afectación están relacionados entre sí pero no con los procesos de formación y desarrollo.
    ...
    > Falso. Todos los procesos de gestión de RRHH están interrelacionados.
...
2. La descripción del puesto es el documento que recoge la información relativa a cada puesto en relación con las tareas, obligaciones, responsabilidades y condiciones laborales.

    - (x) Verdadero
    - ( ) Falso

3. La descripción del puesto de trabajo es el documento que recoge el perfil del puesto, es decir, los conocimientos, habilidades, experiencias y formación necesarios para desempeñarlo.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Eso es la especificación del puesto. La descripción recoge tareas, obligaciones, responsabilidades y condiciones laborales.

4. Los trabajadores temporales son los que tienen una jornada laboral más reducida.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Trabajan bajo un contrato de duración determinada; no implica jornada reducida.

5. Los trabajadores temporales son los que trabajan un periodo corto de tiempo para adquirir experiencia laboral y, además, tienen una jornada laboral más reducida.

    - ( ) Verdadero
    - (x) Falso

    > Falso. No tienen por qué tener una jornada laboral reducida.

6. La reingeniería es la reconsideración fundamental y el rediseño radical de los procesos de la empresa para lograr mejoras trascendentales en desempeño, coste, calidad, servicio y rapidez; se hace en torno a resultados y afecta a la descripción de puestos.

    - (x) Verdadero
    - ( ) Falso

7. La observación como método utilizado en el análisis de puestos permite analizar varios puestos de manera simultánea a un bajo coste.
...
8. La observación como método utilizado en el análisis de puestos permite recoger la opinión de un grupo de personas especialistas.
    ...
    > Falso. Recoger la opinión de especialistas corresponde a la técnica de grupos de expertos, no a la observación.

9. El análisis de puestos de trabajo es el proceso a través del cual la empresa recopila y analiza la información sobre el puesto para identificar las tareas, obligaciones y responsabilidades del puesto.

    - (x) Verdadero
    - ( ) Falso

10. El análisis de puestos de trabajo recopila información con la intención de identificar únicamente las tareas y obligaciones del puesto.

    - ( ) Verdadero
    - (x) Falso

    > Falso. También identifica las responsabilidades del puesto.

11. Cuando el análisis de puestos implica redactar la descripción teniendo en cuenta no solo tareas y responsabilidades, sino también conocimientos, experiencias y competencias, se refiere al análisis multifuncional.

    - (x) Verdadero
    - ( ) Falso

12. Ese mismo análisis (que incluye conocimientos, experiencias y competencias) se refiere a la reingeniería.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La reingeniería es rediseño radical de procesos. Lo descrito es el análisis multifuncional.

13. Entre las técnicas utilizadas para realizar el rediseño de puestos se encuentran la simplificación del puesto, la ampliación del puesto y la reestructuración del puesto.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La reestructuración no es una técnica de rediseño de puestos.

14. Entre las técnicas utilizadas para realizar el rediseño de puestos se encuentran la simplificación del puesto, la ampliación del puesto y el enriquecimiento del puesto.
...
15. La rotación de puestos es una técnica adecuada para rediseñar un puesto cuando se pretende solventar los problemas derivados de un bajo nivel de especialización.
    ...
    > Falso. La rotación de puestos es adecuada para solventar los problemas derivados de un ALTO nivel de especialización (favorece la diversidad de tareas y rompe la rutina).

16. Los problemas derivados de un puesto con alto nivel de especialización pueden solucionarse a través de la simplificación del trabajo.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Se solucionan a través de la ampliación o el enriquecimiento del puesto, no de la simplificación.

17. En la fase de análisis de puestos de trabajo se trata, entre otras cosas, de reunir las características y capacidades humanas necesarias.

    - (x) Verdadero
    - ( ) Falso

18. Determinar qué puestos de trabajo se van a analizar pertenece a la fase de análisis de puestos.
...
1. En la planificación empresarial la empresa analiza la cualificación actual de la plantilla.
    ...
    > Falso. El análisis de la cualificación de la plantilla se hace en la planificación de RRHH, no en la empresarial.

2. En la planificación de RRHH se analiza si la plantilla de la empresa es suficiente y si hay que iniciar procesos de reclutamiento y selección.
...
3. En la planificación de RRHH se hace un estudio sobre las fuerzas del mercado.
    ...
    > Falso. El estudio de las fuerzas del mercado se realiza en la planificación empresarial.

4. La alta tasa de paro en un país hace que aumente la oferta de personal.
...
6. La demanda de RRHH de una empresa no se puede planificar.
    ...
    > Falso. La demanda puede y debe ser planificada.

7. La planificación de RRHH es lo mismo que la planificación empresarial.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La planificación de RRHH asegura el número suficiente de personal, con la cualificación adecuada y en el momento oportuno; la empresarial cubre aspectos económicos, fuerzas de mercado, etc. Son distintas (la de RRHH complementa a la empresarial).

8. La planificación de RRHH es un proceso más completo y complejo que la planificación de plantillas.
...
9. El coste de un programa de outplacement o recolocación se descuenta de la indemnización de despido del empleado.
    ...
    > Falso. La empresa que despide se hace cargo íntegramente del coste; no se descuenta de la indemnización.

10. El programa de outplacement o recolocación es un programa creado para ayudar a los empleados despedidos a superar el estrés emocional y a buscar nuevo empleo.

    - (x) Verdadero
    - ( ) Falso

11. La limitación de la contratación es una medida con la que se puede corregir el defecto en la oferta de personal.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Corrige el EXCESO de oferta de personal. El defecto (faltan trabajadores) se corrige contratando.

12. Los planes de RRHH se pueden clasificar en planes a largo, medio y corto plazo.
...
13. La planificación de la sucesión permite tomar decisiones sobre las promociones internas.
    ...
    > Verdadero. Se basa en la oferta interna de la empresa.

14. La ruptura laboral voluntaria está formada por la dimisión y los despidos.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La ruptura voluntaria es dimisión, jubilación y jubilación anticipada. Los despidos son ruptura involuntaria.

15. La ruptura laboral involuntaria incluye despidos, reducciones de plantilla y jubilación anticipada.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La involuntaria son despidos (individuales o colectivos) y reducciones de plantilla; la jubilación anticipada es voluntaria.

16. La ruptura laboral voluntaria comprende la dimisión, la jubilación y la jubilación anticipada.

    - (x) Verdadero
    - ( ) Falso

17. La ruptura laboral supone la desvinculación del empleado con la empresa y puede ser voluntaria o involuntaria.

    - (x) Verdadero
    - ( ) Falso

18. Si la desvinculación del empleado con la empresa es voluntaria, no se considera ruptura laboral.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La ruptura laboral puede ser tanto voluntaria como involuntaria.

19. La excedencia es una supresión laboral.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La excedencia es una suspensión laboral (temporal). La supresión es la eliminación del puesto de trabajo.

20. Entre las alternativas a la reducción de plantillas se proponen contratar nuevos empleados, renovar contratos que finalizan y aumentar las horas extras.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Esas medidas son contraproducentes para reducir plantilla. Una alternativa válida es incentivar excedencias voluntarias.

21. Para obtener información sobre la oferta externa de trabajo se usan las auditorías de RRHH en las empresas.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Las auditorías de RRHH dan información sobre la oferta INTERNA (resumen de habilidades y conocimientos de los empleados).

22. Los organigramas recogen el porcentaje de empleados que mantienen su puesto año a año.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Eso es el análisis de Markov. Los organigramas representan la estructura organizativa (ocupantes y necesidades futuras de personal).

23. Un ERE es un proceso sustractivo de reducción de plantilla y, por tanto, una ruptura laboral involuntaria.

    - (x) Verdadero
    - ( ) Falso

24. La excedencia debida a la designación o elección para un cargo público o a funciones sindicales de ámbito provincial o superior se considera excedencia forzosa (obligatoria).
...
3. La socialización formal se desarrolla fundamentalmente a través de los compañeros de trabajo.
    ...
    > Falso. La formal se desarrolla a través de la dirección; la que se desarrolla a través de los compañeros es la socialización informal.

4. Entre los métodos de orientación destacan las charlas divulgativas, las visitas a las instalaciones y la entrega de manuales.
...
2. El coaching es una herramienta que ayuda a potenciar el desarrollo de las personas mediante un proceso de reflexión para identificar, incorporar o desarrollar nuevas habilidades y competencias, favoreciendo un mejor desempeño actual y futuro.

    - (x) Verdadero
    - ( ) Falso

3. El alcance de la formación es el grupo o la organización.

    - ( ) Verdadero
    - (x) Falso

    > Falso. La formación es individual; el alcance de grupo u organización corresponde al desarrollo.

4. El método 70-20-10 se basa en tres fuentes: aprendizaje experimental (70%), interacción social (20%) y aprendizaje formal (10%).

    - (x) Verdadero
    - ( ) Falso

    > Verdadero. 70% experiencia (trabajando), 20% exposición (aprender de otros), 10% educación (formación formal).

5. El método 70-20-10 asigna un 70% a la formación teórica, un 20% a la formación online y un 10% a la formación fuera del puesto.

    - ( ) Verdadero
    - (x) Falso

    > Falso. El 70% es experiencia (trabajando), el 20% exposición (aprender de otros) y el 10% educación (formación formal).

6. Las fases del programa de formación son: identificación de las necesidades, diseño y evaluación.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Son 4 fases: identificación de necesidades, diseño, implantación y evaluación.

7. Uno de los beneficios indirectos de la formación es que incide positivamente en variables de RRHH como el compromiso y los niveles de rotación o absentismo.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Es un beneficio directo de la formación, no indirecto.

8. La empleabilidad consiste en establecer redes de contacto profesional que permitan al empleado conocerse mejor a sí mismo y al negocio, escuchando y aprendiendo de otros.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Esa es la definición de networking.

9. La carrera profesional recoge la sucesión de actividades laborales y puestos de trabajo desempeñados por una persona dentro de una misma empresa.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Es a lo largo de toda su vida laboral, tanto dentro como fuera de la empresa.

10. El desarrollo de una marca personal adecuada permite a las empresas incrementar su capacidad para atraer y retener a trabajadores altamente cualificados.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Eso es el employer branding. La marca personal (personal branding) aumenta la empleabilidad y la visibilidad del trabajador.

11. El mentor es un profesional experimentado de la organización que guía a otro empleado con especial talento.

    - (x) Verdadero
    - ( ) Falso

12. Mientras que la formación está más orientada a preparar al trabajador para el futuro, el desarrollo se centra en las necesidades formativas actuales de los individuos.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Es al revés: la formación atiende necesidades actuales del puesto y el desarrollo se proyecta hacia el futuro.

13. Cuando un directivo experimentado y especializado en digitalización ejerce de mentor de un trabajador recién incorporado, se denomina Reverse Mentoring.

    - ( ) Verdadero
    - (x) Falso

    > Falso. En el Reverse Mentoring son los trabajadores más jóvenes quienes tutorizan a los de mayor experiencia en aspectos novedosos (como la digitalización).

14. Es necesario que el coach tenga experiencia en el área donde asesora al coachee para poder ayudarle a maximizar su potencial.

    - ( ) Verdadero
    - (x) Falso

    > Falso. No es necesario en el coaching (el coach es un facilitador). Sí es necesario en el mentoring, donde el mentor debe tener experiencia en el área.

15. El outdoor training es una formación mayoritariamente teórica que se imparte al aire libre para adquirir conocimientos más que habilidades y actitudes.
...
3. La evaluación del rendimiento es un proceso de 4 etapas.
    ...
    > Falso. Son 3 etapas: delimitación de la evaluación, evaluación del rendimiento y gestión y mejora del rendimiento.

4. Lo más habitual es que sea el departamento de RRHH el único encargado de realizar las evaluaciones a los empleados.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Las evaluaciones las realizan superiores, compañeros, clientes, el propio trabajador (autoevaluación), etc.

5. La evaluación 360º es la evaluación a través de todos los medios; es el método más completo y complejo.

    - (x) Verdadero
    - ( ) Falso

6. Existen dos criterios de evaluación: criterios objetivos y subjetivos.
...
7. Los criterios subjetivos de evaluación del rendimiento valoran los comportamientos, actitudes y capacidades de los trabajadores en el desempeño de su labor.
    ...
    > Verdadero. Los objetivos, en cambio, se basan en los resultados.

8. Los métodos con base en el desempeño pasado son las medidas de productividad y el historial de logros.

    - (x) Verdadero
    - ( ) Falso

9. El método con base en el desempeño futuro es la dirección o administración por objetivos.

    - (x) Verdadero
    - ( ) Falso

10. El efecto halo (y eco) se produce cuando el evaluador generaliza una característica específica del evaluado a todos los aspectos de la evaluación, dando un resultado superior o inferior al merecido.

    - (x) Verdadero
    - ( ) Falso

11. A la hora de evaluar el rendimiento, el efecto halo se produce cuando el evaluador quiere evitar problemas con los evaluados y califica de forma indulgente, dando una calificación mayor de la que merece el trabajador.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Eso es el error de lenidad. El efecto halo es generalizar una característica concreta a todas las dimensiones de la evaluación.

12. El error de lenidad se produce cuando el evaluador, para evitar problemas con los evaluados, califica de forma indulgente, dando en general una calificación más alta.

    - (x) Verdadero
    - ( ) Falso

13. El error de severidad consiste en calificar de forma desfavorable por falta de experiencia del evaluador, desconocimiento de los factores o para impresionar a los superiores.

    - (x) Verdadero
    - ( ) Falso

14. Se produce un error de primacía cuando el evaluador valora únicamente los comportamientos o resultados recientes y elimina la información anterior.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Valorar solo lo reciente es el error de recencia. El error de primacía da más peso a la información inicial. (Atención: en algún enunciado del banco se confunde con lenidad.)

15. El etnocentrismo es la tendencia a considerar que los valores propios son siempre los más deseables.
...
16. Los procesos sustractivos solo afectan a los procesos de evaluación y compensación, ya que se trata de una etapa final en la gestión de RRHH.
    ...
    > Falso. Los procesos sustractivos afectan a todo el proceso de gestión de RRHH.

17. Los tipos de procesos sustractivos son la desvinculación voluntaria o involuntaria del trabajador.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Esos son los tipos de ruptura. Los procesos sustractivos pueden ser temporales o permanentes.

18. Un indicador de la ruptura laboral existente en una empresa es la tasa o índice de rotación laboral.
...
19. Con la excedencia existe una desvinculación temporal del trabajador con la empresa que lleva a la extinción del contrato de trabajo.
    ...
    > Falso. La excedencia implica la suspensión del contrato, no su extinción.

20. Los sistemas de outplacement mezclan el coaching con la recolocación de los empleados en el mercado.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Esa mezcla de coaching y recolocación se denomina coachplacement.

21. La autoevaluación es una fuente de evaluación del desempeño que incrementa el compromiso de los empleados, pero debe usarse teniendo en cuenta los sesgos que conlleva.

    - (x) Verdadero
    - ( ) Falso

22. Los métodos de medición objetivos (de resultados) miden el rendimiento en función de lo que aporta la persona a la organización con su trabajo.

    - (x) Verdadero
    - ( ) Falso

23. La evaluación del rendimiento no tiene ninguna relación con el sistema de retribución de la empresa.
...
1. Las empresas piensan que el principal motivante del trabajador es el dinero.
    ...
    > Falso. Influyen también otros factores como el aprendizaje, el reconocimiento o el desarrollo profesional.

2. La retribución o compensación total es el conjunto de percepciones financieras, servicios o beneficios tangibles que recibe el empleado como consecuencia de su actividad en la organización.

    - (x) Verdadero
    - ( ) Falso

3. El dinero es extrínseco y las otras compensaciones motivantes son intrínsecas.

    - (x) Verdadero
    - ( ) Falso

4. La retribución no financiera (factores intrínsecos) se basa en 3 elementos fundamentales: autonomía, ambiente de trabajo y flexibilidad.

    - (x) Verdadero
    - ( ) Falso

5. La retribución financiera indirecta mediante prestaciones no suele pagarse de forma directa al empleado y se percibe por el hecho de formar parte de la organización.

    - (x) Verdadero
    - ( ) Falso

6. La retribución financiera directa puede ser fija o variable.

    - (x) Verdadero
    - ( ) Falso

7. Las dietas no son prestaciones ni salarios, sino simplemente un gasto empresarial.

    - (x) Verdadero
    - ( ) Falso

8. La equidad o consistencia interna se refiere a lograr una retribución justa haciendo que los individuos del mismo nivel o con contribuciones similares reciban la misma retribución.

    - (x) Verdadero
    - ( ) Falso

9. La equidad o competitividad externa se refiere a que la retribución sea justa respecto a lo que se percibe en puestos similares en otras empresas.

    - (x) Verdadero
    - ( ) Falso

10. Existe equidad individual retributiva si dos individuos que ocupan un puesto similar pero que no contribuyen de forma similar a la organización no reciben la misma retribución.

    - (x) Verdadero
    - ( ) Falso

    > Verdadero. En la equidad individual se cobra distinto por resultados o contribuciones distintas.

11. La política salarial es el conjunto de principios y directrices que reflejan la orientación y filosofía de la organización respecto al sistema de retribución.

    - (x) Verdadero
    - ( ) Falso

12. La flexibilidad laboral, las prestaciones sociales y el clima laboral se consideran tipos de retribución no financiera.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Las prestaciones sociales son un tipo de retribución financiera indirecta. La no financiera la forman el ambiente laboral, la flexibilidad y las características del puesto.

13. El buen ambiente laboral, la flexibilidad horaria y los tickets guardería son considerados un tipo de remuneración indirecta.

    - ( ) Verdadero
    - (x) Falso

    > Falso. Los tickets guardería sí son remuneración indirecta, pero el ambiente y la flexibilidad son retribución no financiera (emocional).

14. La retribución basada en competencias es un sistema donde se paga por el valor atribuido a los deberes, responsabilidades y tareas del trabajo y sus condiciones laborales.

    - ( ) Verdadero
    - (x) Falso

    > Falso. En la retribución basada en competencias se paga en función de las aptitudes, conocimientos, habilidades y capacidades del trabajador. Lo descrito es la retribución basada en el puesto.

15. Para determinar el salario base de cada puesto se pueden usar la retribución basada en el puesto de trabajo y la basada en competencias o habilidades; para los incentivos se usa la retribución basada en el rendimiento.
...
1. Dentro de los procesos sustractivos clasificaremos al ERTE como una suspensión del contrato de trabajo mientras que el ERE se clasificaría como una ruptura laboral.
    ...
    - ( ) Falso
     ...
     El ERTE es una suspensión temporal del contrato de trabajo (el vínculo contractual no se rompe y el trabajador tiene derecho a reincorporarse), mientras que el ERE es una ruptura laboral (despido colectivo o extinción del contrato).
...
8. Los tests psicotécnicos son medidas objetivas y estandarizadas que analizan determinadas capacidades (verbales, de razonamiento...) o aptitudes y personalidad de los candidatos.
    ...
    - ( ) Falso
     ...
     Los tests psicotécnicos son instrumentos estandarizados que permiten medir de forma objetiva aptitudes cognitivas y rasgos de personalidad relevantes para el puesto.
...
10. Una técnica de selección es fiable si los resultados obtenidos al aplicarla son consistentes en el tiempo y entre entrevistadores.
    ...
    - ( ) Falso
     ...
     La fiabilidad se refiere a la consistencia de la medida: que aplicada en diferentes momentos o por diferentes evaluadores, produzca resultados similares.
...
12. El mentor es un profesional experimentado de la organización que guía a otro empleado con especial talento.
    ...
    - ( ) Falso
     ...
     El mentoring consiste en que un profesional senior y experimentado guía y apoya el desarrollo profesional de un empleado con potencial.
...
17. Los criterios subjetivos de evaluación del rendimiento valoran los comportamientos, actitudes y capacidades de los trabajadores en el desempeño de su labor.
    ...
    - ( ) Falso
     ...
     Los criterios subjetivos incluyen la valoración de comportamientos, actitudes y capacidades, a diferencia de los criterios objetivos que se basan en resultados medibles.
...
19. Existe equidad individual retributiva si dos individuos que ocupan un puesto similar pero que no contribuyen de forma similar a la organización, no reciben la misma retribución.
    ...
    - ( ) Falso
     ...
     La equidad individual o personal reconoce las diferencias de rendimiento y contribución entre empleados del mismo puesto, retribuyendo de forma diferente según su desempeño.
...
1. ¿Qué es la cultura organizacional?
    ...
    - (x) El conjunto de valores y prácticas que rigen el comportamiento de los empleados en una empresa.
    - ( ) La estructura formal de una empresa, incluyendo sus políticas y procedimientos.
    - ( ) El proceso de selección de personal en una empresa.
    - ( ) El proceso de evaluación del desempeño de los empleados.

2. ¿Cuál de los siguientes NO es un método común de evaluación del desempeño?

    - ( ) Entrevista de salida.
    - ( ) Autoevaluación.
    - ( ) Evaluación 360 grados.
    - (x) Evaluación de habilidades matemáticas.

3. ¿Cuál es el propósito de un proceso de retroalimentación efectivo?

    - ( ) Identificar problemas de comunicación entre los empleados y la gerencia.
    - (x) Fomentar el desarrollo profesional y personal de los empleados.
    - ( ) Establecer objetivos y metas para la empresa.
    - ( ) Resolver conflictos entre los empleados.

4. ¿Qué es el liderazgo transformacional?

    - ( ) Un estilo que se enfoca en recompensar a los empleados por su desempeño.
    - ( ) Un estilo que supervisa de cerca a los empleados para asegurar que cumplen sus responsabilidades.
    - (x) Un estilo que se enfoca en motivar y empoderar a los empleados para que alcancen su máximo potencial.
    - ( ) Un estilo que se enfoca en mantener la estabilidad y el orden en la empresa.

5. ¿Cuál es el objetivo de la gestión del talento?

    - ( ) Identificar las fortalezas y debilidades de los empleados.
    - (x) Planificar y desarrollar la carrera de los empleados dentro de la empresa.
    - ( ) Gestionar el proceso de selección de personal.
    - ( ) Supervisar el cumplimiento de las políticas y procedimientos.

6. ¿Qué es la diversidad en el lugar de trabajo?

    - ( ) El proceso de selección de personal en una empresa.
    - ( ) La variedad de habilidades técnicas que tienen los empleados.
    - (x) La variedad de antecedentes y características personales que tienen los empleados.
    - ( ) La cantidad de empleados que trabaja en una empresa.

7. ¿Qué es el desarrollo organizacional?

    - ( ) El proceso de selección de personal en una empresa.
    - ( ) La estrategia de crecimiento de una empresa.
    - (x) El proceso de cambio planificado en una empresa.
    - ( ) La evaluación del desempeño de los empleados.

8. ¿Cuál es el objetivo principal de la compensación y los beneficios?

    - ( ) Asegurar que los empleados tengan la formación y habilidades necesarias.
    - (x) Proporcionar a los empleados un salario justo y beneficios competitivos.
    - ( ) Motivar a los empleados para que cumplan con sus responsabilidades.
    - ( ) Establecer objetivos y metas para la empresa.

9. ¿Qué es el liderazgo situacional?

    - ( ) Un estilo que recompensa a los empleados por su desempeño.
    - ( ) Un estilo que supervisa de cerca a los empleados.
    - (x) Un estilo que se adapta a las necesidades individuales y a las situaciones específicas de los empleados.
    - ( ) Un estilo que se enfoca en mantener la estabilidad y el orden.

10. ¿Qué es la capacitación en el lugar de trabajo?

    - ( ) La estrategia de crecimiento de una empresa.
    - ( ) La variedad de habilidades técnicas que tienen los empleados.
    - (x) El proceso de enseñar habilidades y conocimientos específicos a los empleados.
    - ( ) El proceso de identificar fortalezas y debilidades de los empleados.

<!-- Quizizz (todos los temas) -->

1. La inseguridad laboral, como factor de influencia en la gestión de los RRHH, es de carácter:
    ...
    > Afecta a la persona concreta y a su relación con el puesto, por lo que se clasifica como factor individual.

2. ¿Cómo debe ser el perfil del director de RRHH?

    - ( ) Solo un negociador con la representación sindical.
    - (x) A la vez estratega, agente del cambio y conocedor del negocio.
    - ( ) Exclusivamente un experto en legislación laboral.
    - ( ) Únicamente un gestor administrativo de nóminas y contratos.

    > El rol moderno integra varias facetas simultáneamente, no una sola.

3. ¿Qué abarca la gestión de la diversidad generacional?

    - ( ) Únicamente a los trabajadores próximos a la jubilación.
    - (x) A todas las generaciones presentes y a su interrelación.
    - ( ) Solo a los millennials y la generación Z.
    - ( ) Solo a las generaciones más jóvenes incorporadas a la empresa.

    > Busca integrar y aprovechar la convivencia entre todas las generaciones, no segmentar una.

4. Coaching, mentoring y outdoor training son nuevas tendencias vinculadas con los procesos de:
    ...
    > Son metodologías orientadas a desarrollar capacidades, propias del proceso de formación y desarrollo.

5. Entre los rankings de "buenos empleadores" (employer branding) podemos citar:

    - ( ) El IBEX 35 y el ranking Forbes de patrimonios.
    - ( ) El escalafón de la función pública.
    - ( ) El convenio colectivo del sector.
    - (x) Great Place to Work, Merco Talento y los premios Top Employers.

    > Son sellos y clasificaciones reputacionales de atracción de talento, no índices financieros ni normativos.

6. Los procesos de afectación engloban las siguientes prácticas de RRHH:

    - (x) Reclutamiento, selección y socialización.
    - ( ) Análisis de puestos y planificación.
    - ( ) Retribución, incentivos y prestaciones.
    - ( ) Formación, desarrollo y evaluación.

    > La afectación cubre la incorporación y encaje del trabajador: reclutar, seleccionar y socializar.

7. En relación con la existencia de un departamento de RRHH formalizado:

    - ( ) Solo existe en empresas del sector público.
    - (x) Tiende a existir conforme aumenta la complejidad de la organización.
    - ( ) Aparece igual en cualquier empresa con independencia de su tamaño.
    - ( ) Desaparece a medida que la empresa crece.

    > A mayor complejidad y tamaño, más necesario es un departamento especializado.

8. La visión proactiva del departamento de RRHH implica:

    - ( ) Actuar solo cuando surge un problema laboral.
    - ( ) Reducir su papel al cumplimiento normativo.
    - ( ) Limitarse a tramitar nóminas y contratos.
    - (x) Participar en la formulación e implantación de la estrategia.

    > Lo proactivo es anticiparse e integrarse en la estrategia, frente a la visión reactiva administrativa.

9. Respecto a los procesos básicos de RRHH, señale la opción correcta:

    - (x) Se integran por el análisis de los puestos y la planificación de los RRHH.
    - ( ) Se integran por la formación y la evaluación.
    - ( ) Se integran por el reclutamiento y la selección.
    - ( ) Se integran por la retribución y la motivación.

    > Los procesos básicos son análisis de puestos y planificación; el resto son afectación, desarrollo, etc.

10. La atracción y retención del talento, como objetivo de la gestión de los RRHH, es de tipo:
    ...
    > Es un objetivo declarado y explícito de la función de RRHH.

11. El análisis y diseño de puestos se integra dentro de los procesos:
    ...
    > Junto con la planificación, forma parte de los procesos básicos.

12. En el análisis del puesto de trabajo se tienen en consideración:

    - (x) Las tres dimensiones de forma simultánea.
    - ( ) Solo las condiciones del entorno.
    - ( ) Solo los requisitos del ocupante.
    - ( ) Solo las tareas a realizar.

    > Se valoran a la vez tareas, requisitos y condiciones, no una aislada.

13. En cuanto a la delimitación del análisis del puesto de trabajo (APT):

    - ( ) La realiza exclusivamente el comité de empresa.
    - ( ) Solo la puede realizar un consultor externo.
    - ( ) Solo la puede realizar el departamento de RRHH.
    - (x) La puede realizar el ocupante del puesto, el superior o el departamento de RRHH.

    > Hay varias fuentes válidas; no es competencia exclusiva de RRHH.

14. Si para obtener datos del puesto el empleado responde a preguntas cerradas sobre las necesidades del trabajo, se está usando:

    - ( ) La observación directa.
    - ( ) El diario de actividades.
    - (x) El cuestionario cerrado.
    - ( ) La entrevista en profundidad.

    > Preguntas cerradas y estandarizadas corresponden al método de cuestionario cerrado.

15. Las entrevistas, como técnica de análisis de puestos, se caracterizan por:

    - ( ) Bajo coste y nula influencia del analista.
    - ( ) Bajo coste pero alta influencia del analista.
    - ( ) Alto coste pero total objetividad.
    - (x) Alto coste e influencia elevada del analista.

    > Son costosas en tiempo y muy sensibles al sesgo de quien las conduce.

16. Los grupos de expertos, como técnica de análisis de puestos:

    - ( ) Se usan únicamente para fijar salarios.
    - (x) Se aplican para puestos de nueva creación o rediseño de puestos.
    - ( ) Sustituyen siempre a la observación directa.
    - ( ) Solo sirven para puestos operativos ya consolidados.

    > Resultan útiles cuando no hay ocupante previo: puestos nuevos o rediseñados.

17. La técnica empleada para definir conocimientos, habilidades y aptitudes de un puesto se denomina:

    - (x) Análisis de inventario de tareas.
    - ( ) Diagrama de flujo de procesos.
    - ( ) Cuestionario de posición (PAQ) financiero.
    - ( ) Método de incidentes críticos.

    > El inventario de tareas detalla las competencias requeridas por el puesto.

18. La descripción del puesto debe recoger, en un mismo documento:

    - ( ) Solo las funciones principales.
    - ( ) Solo el salario asociado.
    - ( ) Solo la denominación y la dependencia jerárquica.
    - (x) Identificación, funciones, condiciones y relaciones del puesto de forma conjunta.

    > Integra varios apartados en un único documento, no un dato aislado.

19. "La descripción del puesto recoge la información sobre las características que debería tener la persona que lo ocupe."

    - ( ) Verdadero
    - (x) Falso

    > Eso corresponde a la especificación del puesto; la descripción se centra en tareas y condiciones.

20. La especificación del puesto incluye:

    - ( ) El listado de clientes asignados.
    - ( ) El organigrama completo del departamento.
    - (x) La cualificación mínima exigida al ocupante.
    - ( ) El salario base y los complementos.

    > Define los requisitos mínimos (formación, experiencia, aptitudes) del ocupante.

21. El enriquecimiento del puesto, a diferencia de la ampliación, se caracteriza por:

    - ( ) Añadir más tareas del mismo nivel de dificultad.
    - (x) Incorporar mayor grado de control y responsabilidad sobre las tareas.
    - ( ) Reducir el número de funciones del puesto.
    - ( ) Rotar al trabajador entre puestos distintos.

    > El enriquecimiento es vertical (más autonomía); la ampliación es horizontal (más tareas similares).

22. La semana laboral comprimida permite, sobre todo:

    - (x) Aumentar el grado de flexibilidad laboral.
    - ( ) Eliminar el descanso semanal obligatorio.
    - ( ) Reducir la responsabilidad del puesto.
    - ( ) Incrementar el número total de horas trabajadas.

    > Concentra la jornada en menos días, ganando flexibilidad para el trabajador.

23. Como inconveniente del teletrabajo intensivo (p. ej. en pandemia) podemos señalar:

    - ( ) El aislamiento y la dificultad de cohesión del equipo.
    - (x) Todos los anteriores son inconvenientes del teletrabajo.
    - ( ) Las mayores dificultades de supervisión y control.
    - ( ) La confusión entre vida laboral y personal.

    > Concurren varios inconvenientes simultáneamente, no uno solo.

24. El análisis de puestos basado en competencias:

    - (x) Se orienta al trabajador y a lo que es capaz de hacer.
    - ( ) Prescinde de los conocimientos y habilidades.
    - ( ) Solo valora la antigüedad en la empresa.
    - ( ) Se centra en las tareas del puesto con independencia de la persona.

    > El enfoque por competencias mira capacidades de la persona, no solo las tareas.

25. En cuanto al trabajo en equipo en el diseño de puestos:

    - ( ) Facilita la resolución conjunta de problemas.
    - (x) Aporta todas las ventajas anteriores a la vez.
    - ( ) Mejora la flexibilidad y la polivalencia.
    - ( ) Favorece la motivación y el compromiso.

    > El trabajo en equipo combina varios beneficios simultáneos.

26. La demanda de recursos humanos puede variar en función de:

    - ( ) Factores de la propia fuerza de trabajo.
    - ( ) Factores del entorno externo.
    - ( ) Factores organizativos internos.
    - (x) Todos los factores anteriores.

    > La demanda depende de varios bloques de factores a la vez.

27. La demanda de trabajadores depende únicamente del tiempo en el caso de:

    - ( ) La técnica Delphi.
    - ( ) El juicio de directivos.
    - (x) El análisis de tendencias.
    - ( ) La técnica de grupo nominal.

    > El análisis de tendencias extrapola a partir de la evolución temporal pasada.

28. La reunión presencial de un grupo de expertos para estimar necesidades se denomina:

    - ( ) Auditoría de RRHH.
    - ( ) Análisis de regresión.
    - (x) Técnica de grupo nominal.
    - ( ) Técnica Delphi.

    > La técnica de grupo nominal reúne a los expertos de forma presencial.

29. Existe dificultad para integrar las opiniones de los expertos, por su carácter anónimo e iterativo, en el caso de:
    ...
    > El Delphi es anónimo y por rondas, lo que complica integrar opiniones.

30. El potencial de los trabajadores puede conocerse adecuadamente a través de:

    - ( ) El balance contable.
    - ( ) El organigrama de la empresa.
    - ( ) El análisis de tendencias.
    - (x) Las auditorías de Recursos Humanos.

    > Las auditorías de RRHH (inventarios de personal) revelan capacidades y potencial.

31. "El análisis de los movimientos de los trabajadores considerando el porcentaje que promociona se denomina análisis de Markov."

    - (x) Verdadero
    - ( ) Falso

    > El análisis de Markov estudia transiciones y probabilidades de promoción entre puestos.

32. Los planes de RRHH deben recoger:

    - ( ) Solo las líneas de acción.
    - ( ) Solo el reparto de responsabilidades.
    - ( ) Solo los recursos y la temporalización.
    - (x) Líneas de acción, responsabilidades, recursos y temporalización.

    > Un plan completo integra qué, quién, con qué y cuándo.

33. Una de las funciones de los planes de RRHH consiste en planificar:

    - ( ) Las políticas retributivas.
    - ( ) Las necesidades de plantilla.
    - (x) Todos los aspectos anteriores de forma integrada.
    - ( ) Las acciones formativas.

    > La planificación abarca varias áreas de la gestión de personas.

34. El Sistema de Información de RRHH (SIRH) abarca información para:

    - ( ) La administración de personal.
    - (x) Todos los usos anteriores.
    - ( ) El control y seguimiento de plantillas.
    - ( ) La toma de decisiones estratégicas.

    > El SIRH da soporte tanto operativo como estratégico.

35. En relación con el SIRH, una exigencia esencial es que:

    - (x) Debe garantizar la seguridad y confidencialidad de los datos.
    - ( ) Debe ser accesible públicamente para toda la plantilla.
    - ( ) Debe prescindir de cualquier control de acceso.
    - ( ) Debe almacenar solo datos económicos.

    > Maneja datos personales sensibles, por lo que la seguridad es prioritaria.

36. En relación con la excedencia forzosa, señale la opción correcta:

    - ( ) No da derecho a reserva del puesto.
    - (x) Las afirmaciones anteriores son incorrectas.
    - ( ) Se concede por un máximo de un año.
    - ( ) Computa antigüedad solo en el sector privado.

    > La excedencia forzosa da derecho a reserva del puesto y cómputo de antigüedad; las opciones previas son falsas.

37. La excedencia voluntaria:

    - ( ) Da derecho a reserva del mismo puesto de trabajo.
    - ( ) Tiene una duración máxima de 6 meses.
    - (x) Puede volver a ejercerse por el trabajador si han transcurrido al menos 4 años.
    - ( ) Se concede únicamente por motivos de salud.

    > Solo otorga derecho preferente al reingreso y exige un intervalo de 4 años para repetirla.

38. En relación con la excedencia por cuidado de familiares:

    - (x) Tiene una duración máxima de 3 años para el cuidado de descendientes.
    - ( ) No reserva el puesto de trabajo.
    - ( ) Es incompatible con la reducción de jornada.
    - ( ) Tiene una duración máxima de 1 año en todos los casos.

    > Para descendientes se reconoce hasta 3 años con reserva de puesto durante el primer año.

39. En relación con el ERTE:

    - ( ) Mantiene el vínculo laboral con la empresa.
    - ( ) Suspende o reduce la jornada de forma temporal.
    - ( ) Puede deberse a causas económicas, técnicas, organizativas o de producción.
    - (x) Todas las afirmaciones anteriores son correctas.

    > El ERTE es temporal, conserva el vínculo y responde a causas ETOP o de fuerza mayor.

40. La dimisión constituye:

    - (x) Una ruptura laboral voluntaria por parte del trabajador.
    - ( ) Un despido disciplinario.
    - ( ) Una extinción por causas objetivas de la empresa.
    - ( ) Una suspensión temporal del contrato.

    > La inicia el trabajador de forma unilateral y voluntaria.

41. Respecto a las ventajas de las jubilaciones anticipadas:

    - ( ) Solo benefician al trabajador.
    - ( ) Solo benefician a la empresa.
    - ( ) No suponen ventaja para ninguna de las partes.
    - (x) Benefician tanto al trabajador como al empleador.

    > Permiten rejuvenecer plantilla y, a la vez, atender preferencias del trabajador.

42. En relación con los ERE (extinción colectiva):

    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Requieren un periodo de consultas con la representación.
    - ( ) Se justifican por causas económicas, técnicas, organizativas o de producción.
    - ( ) Suponen extinción definitiva de contratos.

    > El ERE es extintivo, exige consultas y se ampara en causas ETOP.

43. En relación con el "bumping" (desplazamiento), señale la opción correcta:

    - (x) Las afirmaciones anteriores son incorrectas.
    - ( ) Es un método de evaluación del rendimiento.
    - ( ) Consiste en contratar personal externo de forma masiva.
    - ( ) Es una técnica de reclutamiento interno.

    > El bumping es desplazar a un trabajador a otro puesto por antigüedad ante reducciones; las opciones previas son falsas.

44. En relación con el outplacement (recolocación):

    - ( ) Suele apoyarse en consultoras especializadas.
    - ( ) Mejora la imagen de la empresa que lo ofrece.
    - ( ) Ayuda al trabajador desvinculado a reinsertarse laboralmente.
    - (x) Todas las afirmaciones anteriores son correctas.

    > El outplacement combina apoyo al desvinculado, imagen y consultoría externa.

45. Entre los objetivos del outplacement destaca:

    - ( ) Eliminar la indemnización por despido.
    - (x) Mejorar el employer branding de la empresa.
    - ( ) Aumentar la rotación no deseada.
    - ( ) Reducir las cotizaciones sociales de la empresa.

    > Cuidar la salida refuerza la reputación como empleador.

46. En relación con el despido individual:

    - ( ) Es siempre nulo de pleno derecho.
    - (x) Suele ser resultado de un mal rendimiento laboral.
    - ( ) No requiere comunicación al trabajador.
    - ( ) Siempre es colectivo y por causas económicas.

    > El despido individual responde con frecuencia a incumplimientos o bajo rendimiento del trabajador.

47. El reclutamiento se relaciona con:

    - ( ) Las fuentes internas y externas de personal.
    - ( ) La atracción de candidatos cualificados.
    - (x) Todos los aspectos anteriores.
    - ( ) La imagen y marca de empleador.

    > El reclutamiento abarca atracción, fuentes y marca empleadora a la vez.

48. El reclutamiento interno puede ser:

    - ( ) Mediante planes de sucesión.
    - ( ) Mediante promoción vertical.
    - (x) De cualquiera de las formas anteriores.
    - ( ) Mediante traslado horizontal.

    > El reclutamiento interno admite promoción, traslado y sucesión.

49. Como ventaja del reclutamiento interno se destaca que es:

    - ( ) Un modo de evitar la endogamia.
    - ( ) Una fuente de ideas y perfiles nuevos.
    - ( ) Una vía para ampliar la diversidad de la plantilla.
    - (x) Más rápido y económico que el externo.

    > Aprovecha personas ya conocidas, reduciendo coste y tiempo; las otras son ventajas del externo.

50. Como inconvenientes del reclutamiento externo se destacan:

    - ( ) La menor certeza sobre el encaje del candidato.
    - ( ) El posible efecto desmotivador en la plantilla actual.
    - ( ) El mayor coste y duración del proceso.
    - (x) Todos los anteriores.

    > El externo es más caro, lento, incierto y puede frustrar expectativas internas.

51. En relación con el headhunting, la búsqueda puede canalizarse a través de:

    - ( ) El boletín oficial del Estado.
    - ( ) Portales de empleo abiertos.
    - (x) Agencias de colocación y cazatalentos especializados.
    - ( ) Tablones internos de la empresa.

    > El headhunting recurre a agencias y consultoras especializadas en captación directa.

52. En relación con la endogamia en el reclutamiento, señale la opción correcta:

    - ( ) Garantiza siempre la mejor selección posible.
    - ( ) Aumenta la diversidad de perfiles.
    - ( ) Es exclusiva del reclutamiento externo.
    - (x) Implica favoritismo entre el personal de la empresa.

    > La endogamia tiende a reproducir perfiles y a favorecer a los ya presentes.

53. En relación con el VídeoCV, señale la opción correcta:

    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Aporta una primera impresión más dinámica que el CV en papel.
    - ( ) Puede introducir sesgos por apariencia.
    - ( ) Permite mostrar habilidades comunicativas del candidato.

    > El VídeoCV aporta dinamismo y comunicación, pero también riesgo de sesgo.

54. En cuanto a las redes sociales profesionales en reclutamiento:

    - ( ) Permiten verificar trayectoria y contactos.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Reducen costes de difusión de ofertas.
    - ( ) Facilitan el acceso a candidatos pasivos.

    > Las redes profesionales combinan alcance, verificación y bajo coste.

55. Como ventajas del reclutamiento mediante redes sociales destacan:

    - ( ) Su gran alcance y rapidez.
    - (x) Todas las anteriores.
    - ( ) La segmentación del público objetivo.
    - ( ) Su bajo coste relativo.

    > Aúnan alcance, economía y segmentación.

56. El modelo de clasificación en selección conlleva:

    - ( ) Seleccionar un candidato para un único puesto.
    - ( ) Descartar a todos los candidatos internos.
    - ( ) Evaluar solo mediante entrevista.
    - (x) Seleccionar varios candidatos para varios puestos.

    > La clasificación asigna un conjunto de candidatos a un conjunto de puestos.

57. En cuanto a la preselección, el impreso de solicitud:

    - ( ) Solo recoge datos económicos del candidato.
    - (x) Sirve para homogeneizar la información y poder compararla.
    - ( ) Garantiza por sí solo la contratación.
    - ( ) Sustituye a la entrevista final.

    > Normaliza los datos de los candidatos para compararlos en igualdad de condiciones.

58. La relación entre el método de selección y el rendimiento real en el trabajo hace referencia a:

    - ( ) La fiabilidad del método.
    - ( ) La objetividad del evaluador.
    - (x) La validez empírica del método.
    - ( ) La estandarización del método.

    > La validez empírica mide en qué grado el método predice el desempeño posterior.

59. Las dinámicas grupales en selección pueden ser:

    - ( ) De discusión y debate.
    - ( ) De resolución de casos o problemas.
    - ( ) De rol o simulación.
    - (x) De cualquiera de las modalidades anteriores.

    > Admiten formatos diversos: debate, casos, juegos de rol, etc.

60. En relación con los centros de evaluación (assessment centers):

    - ( ) Utilizan varios evaluadores a la vez.
    - ( ) Permiten observar competencias en situaciones simuladas.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Combinan varias pruebas y ejercicios.

    > El assessment center integra múltiples pruebas, evaluadores y simulaciones.

61. Entre las nuevas tendencias en selección destacamos:

    - ( ) El reclutamiento a través de redes sociales.
    - (x) Todas las tendencias anteriores.
    - ( ) La gamificación de las pruebas.
    - ( ) El uso de inteligencia artificial y big data.

    > Conviven IA, gamificación y redes como tendencias actuales.

62. En relación con la socialización, señale la respuesta incorrecta:

    - ( ) Puede ser formal o informal.
    - (x) Es un proceso totalmente objetivo.
    - ( ) Transmite la cultura y los valores de la empresa.
    - ( ) Facilita la integración del nuevo empleado.

    > La socialización tiene un fuerte componente subjetivo y cultural; afirmar que es "objetiva" es falso.

63. Como método de socialización informal destacamos:

    - ( ) El curso de bienvenida estructurado.
    - (x) La interacción espontánea con los compañeros.
    - ( ) El manual del empleado.
    - ( ) El plan de acogida documentado.

    > Lo informal surge del contacto natural y no planificado con el equipo.

64. "La entrevista de selección es un método subjetivo e impreciso."

    - (x) Verdadero
    - ( ) Falso

    > Depende del juicio del entrevistador, lo que la hace subjetiva y poco precisa.

65. "Los tests de capacidades y de personalidad son medidas objetivas y estandarizadas."

    - (x) Verdadero
    - ( ) Falso

    > Se aplican y corrigen con criterios uniformes, lo que les da objetividad y estandarización.

66. Un objetivo de la socialización es:

    - (x) Todos los objetivos anteriores.
    - ( ) Favorecer el compromiso y la permanencia.
    - ( ) Reducir la incertidumbre del nuevo empleado.
    - ( ) Transmitir normas y valores de la organización.

    > La socialización persigue varios fines de integración a la vez.

67. Las dinámicas grupales permiten evaluar y contrastar rasgos de:

    - ( ) Comunicación y trabajo en equipo.
    - (x) Todos los rasgos anteriores.
    - ( ) Liderazgo.
    - ( ) Gestión de conflictos.

    > Sirven para observar varias competencias interpersonales simultáneamente.

68. En las entrevistas estructuradas o sistematizadas:

    - (x) Se gana uniformidad y se pueden distinguir las "respuestas adecuadas".
    - ( ) Se pierde toda capacidad de comparación entre candidatos.
    - ( ) No requieren guion previo.
    - ( ) Las preguntas varían libremente en cada caso.

    > Al seguir un guion común, son más comparables y permiten identificar respuestas idóneas.

69. Comparar a un candidato con un grupo medio de personas situadas por debajo de la media es un efecto de:
    ...
    > El efecto de contraste distorsiona el juicio según con quién se compara al candidato.

70. En cuanto a la evaluación de los programas de formación:

    - ( ) Analiza la transferencia al puesto y los resultados.
    - ( ) Valora el aprendizaje adquirido.
    - ( ) Mide la reacción y satisfacción de los participantes.
    - (x) Contempla todos los niveles anteriores.

    > Sigue niveles tipo Kirkpatrick: reacción, aprendizaje, conducta y resultados.

71. En relación con el mentoring, señale la opción correcta:

    - ( ) Lo imparte siempre una empresa externa.
    - ( ) Se centra exclusivamente en tareas técnicas inmediatas.
    - ( ) Es una relación puntual y de un solo día.
    - (x) Las afirmaciones anteriores son incorrectas.

    > El mentoring es una relación de acompañamiento a medio-largo plazo y desarrollo integral; las opciones previas son falsas.

72. En relación con la autoevaluación, señale la respuesta incorrecta:

    - ( ) Reduce la ambigüedad sobre el papel a desempeñar.
    - ( ) Implica al trabajador en su propio desarrollo.
    - ( ) Puede complementar otras fuentes de evaluación.
    - (x) Está totalmente libre de sesgos del propio evaluado.

    > La autoevaluación está sujeta a sesgos de complacencia; afirmar lo contrario es incorrecto.

73. "El coaching y el mentoring son incompatibles en un mismo puesto."

    - ( ) Verdadero
    - (x) Falso

    > Pueden coexistir y complementarse sobre la misma persona o puesto.

74. En cuanto a la figura del coach:

    - ( ) Acompaña sin imponer soluciones.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Ayuda al desarrollo del potencial del coachee.
    - ( ) Puede ser interno o externo a la empresa.

    > El coach acompaña, desarrolla potencial y puede pertenecer o no a la empresa.

75. La formación que permite integrar intereses de miembros con diferente perfil cultural y valores se denomina formación:
    ...
    > La formación en diversidad busca cohesionar perfiles culturales distintos.

76. En cuanto a la gestión de la carrera profesional, señale la respuesta incorrecta:

    - ( ) Combina objetivos de la persona y de la empresa.
    - ( ) Incluye movimientos horizontales y de enriquecimiento.
    - ( ) Puede apoyarse en planes de sucesión.
    - (x) Contempla únicamente movimientos verticales.

    > La carrera moderna no es solo ascender; afirmar que solo es vertical es incorrecto.

77. En relación con el personal branding, señale la respuesta incorrecta:

    - ( ) Refuerza la reputación profesional propia.
    - (x) Las afirmaciones anteriores son incorrectas.
    - ( ) Ayuda al profesional a diferenciarse.
    - ( ) Puede gestionarse en redes profesionales.

    > Las tres primeras describen correctamente el personal branding; marcarlas como falsas es el error.

78. Pueden actuar como formadores internos:

    - ( ) Las universidades corporativas ajenas.
    - ( ) Los proveedores de software de formación.
    - (x) Los supervisores inmediatos del trabajador.
    - ( ) Las consultoras especializadas externas.

    > El supervisor directo es una fuente típica de formación interna.

79. La formación de tercer nivel permite, fundamentalmente:

    - (x) Adquirir experiencia suficiente para asumir mayores responsabilidades.
    - ( ) Cubrir conocimientos básicos de acogida.
    - ( ) Sustituir a la evaluación del rendimiento.
    - ( ) Adquirir destrezas operativas elementales.

    > El tercer nivel se orienta a desarrollar experiencia y capacidad para puestos superiores.

80. El concepto de carrera profesional incluye:

    - (x) Todos los elementos anteriores.
    - ( ) La sucesión de puestos a lo largo de la vida laboral.
    - ( ) Las expectativas y aspiraciones de la persona.
    - ( ) Las oportunidades que ofrece la organización.

    > Integra trayectoria, aspiraciones personales y oportunidades de la empresa.

81. El shadow coaching se caracteriza por:

    - ( ) Acompañar de forma cercana y continuada.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Aportar feedback inmediato sobre su desempeño.
    - ( ) Observar al profesional en su entorno real de trabajo.

    > El shadow coaching combina observación in situ, feedback y acompañamiento.

82. En relación con el mentoring inverso:

    - ( ) Los veteranos mentorizan a los jóvenes.
    - ( ) Solo se aplica a la alta dirección.
    - ( ) Se prescinde de cualquier relación intergeneracional.
    - (x) Los jóvenes mentorizan a los veteranos.

    > El mentoring inverso invierte el sentido habitual: los más jóvenes guían a los veteranos.

83. En cuanto al método de desarrollo 70-20-10:

    - ( ) El 20% proviene de la interacción con otros.
    - ( ) El 10% proviene de la formación estructurada.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) El 70% proviene de la experiencia en el puesto.

    > El modelo reparte el aprendizaje en experiencia, relaciones y formación formal.

84. "El personal branding permite al trabajador diferenciarse de otros profesionales."

    - (x) Verdadero
    - ( ) Falso

    > La marca personal sirve precisamente para destacar y diferenciarse en el mercado.

85. "La carrera profesional se define como una sucesión de puestos de trabajo desempeñados por una persona en una única empresa."

    - ( ) Verdadero
    - (x) Falso

    > La carrera puede desarrollarse a lo largo de varias organizaciones, no solo en una.

86. Pueden actuar como formadores externos:

    - (x) Las empresas de consultoría especializadas.
    - ( ) Los compañeros del propio equipo.
    - ( ) Los supervisores inmediatos.
    - ( ) El departamento interno de RRHH.

    > Las consultoras especializadas son una fuente típica de formación externa.

87. Las universidades corporativas aportan formación a:

    - ( ) En ocasiones, los clientes de la empresa.
    - ( ) Los empleados de la propia organización.
    - (x) Todos los colectivos anteriores.
    - ( ) Los proveedores y colaboradores.

    > Pueden formar a empleados, partners y clientes según la estrategia de la empresa.

88. "El coach puede pertenecer o no a la empresa."

    - (x) Verdadero
    - ( ) Falso

    > Existen coaches internos y externos a la organización.

89. La rotación de puestos, como técnica de desarrollo:

    - ( ) Solo se aplica a la alta dirección.
    - (x) Puede implicar una permanencia muy breve en cada puesto.
    - ( ) Reduce la polivalencia del trabajador.
    - ( ) Exige siempre cambios definitivos de puesto.

    > La rotación expone al trabajador a varios puestos durante periodos a menudo breves.

90. En relación con la identificación de necesidades de formación a nivel individual:

    - ( ) Se apoya en la evaluación del rendimiento.
    - ( ) Detecta carencias concretas de competencias.
    - ( ) Considera las aspiraciones de carrera de la persona.
    - (x) Todas las afirmaciones anteriores son correctas.

    > Combina rendimiento, aspiraciones y carencias de competencias.

91. La enseñanza directa en el puesto presenta como inconveniente que:

    - (x) Puede interferir en el rendimiento mientras se forma.
    - ( ) Impide cualquier aprendizaje práctico.
    - ( ) Elimina por completo el contacto con el puesto real.
    - ( ) Resulta siempre más cara que la formación externa.

    > Al formar durante la actividad, puede ralentizar o afectar la producción.

92. En relación con el outdoor training, señale la respuesta incorrecta:

    - ( ) Trabaja habilidades como liderazgo y trabajo en equipo.
    - ( ) Emplea actividades experienciales y lúdicas.
    - (x) Aporta formación directamente ligada a las tareas del puesto.
    - ( ) Se desarrolla en entornos al aire libre.

    > El outdoor entrena competencias transversales, no tareas técnicas del puesto; esa afirmación es falsa.

93. En relación con el desarrollo, señale la respuesta incorrecta:

    - ( ) Va más allá de las necesidades inmediatas del puesto.
    - ( ) Busca preparar a la persona para nuevas responsabilidades.
    - (x) Es un proceso reactivo orientado al pasado.
    - ( ) Tiene una orientación de futuro.

    > El desarrollo es proactivo y orientado al futuro; calificarlo de reactivo es el error.

94. En cuanto al aprendizaje 3.0:

    - ( ) Se apoya en entornos digitales y en red.
    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Es colaborativo y social.
    - ( ) Sitúa al aprendiz como protagonista activo.

    > El aprendizaje 3.0 es social, digital y centrado en el propio aprendiz.

95. "La gamificación permite reforzar la creatividad, el trabajo en equipo y la comunicación interna."

    - (x) Verdadero
    - ( ) Falso

    > Aplicar mecánicas de juego estimula creatividad, cooperación y comunicación.

96. La formación en habilidades integradoras versa, entre otras cosas, sobre:

    - ( ) El manejo de una máquina concreta.
    - (x) La capacidad de planificación.
    - ( ) El dominio de un idioma específico.
    - ( ) La normativa fiscal aplicable.

    > Las habilidades integradoras son transversales (planificación, coordinación), no técnicas puntuales.

97. Si el evaluador califica al individuo comparándolo con la evaluación de otro trabajador, se incurre en:

    - ( ) Error de halo.
    - ( ) Error de tendencia central.
    - ( ) Error de indulgencia.
    - (x) Error de contraste.

    > El error de contraste surge al juzgar a una persona en relación con otra y no con el estándar.

98. En relación con la entrevista de evaluación:

    - (x) Todas las afirmaciones anteriores son correctas.
    - ( ) Debe basarse en hechos y no en juicios genéricos.
    - ( ) Es un momento de feedback sobre el desempeño.
    - ( ) Permite acordar objetivos de mejora.

    > La entrevista de evaluación da feedback, fija metas y se apoya en hechos.

99. Son objetivos organizativos de la evaluación del rendimiento:

    - ( ) Sustituir a la política retributiva.
    - (x) Mantener y aumentar la productividad.
    - ( ) Reducir la comunicación con el empleado.
    - ( ) Únicamente cumplir un trámite administrativo.

    > A nivel organizativo busca, entre otros fines, sostener y mejorar la productividad.

100. "La evaluación del rendimiento informal no debe ser tenida en consideración."

    - ( ) Verdadero
    - (x) Falso

    > La evaluación informal del día a día también aporta información útil y debe considerarse.

101. La evaluación del rendimiento formal debe guardar estrecha relación con:

    - (x) Todos los elementos anteriores.
    - ( ) El análisis y la descripción del puesto.
    - ( ) Los criterios y estándares de desempeño.
    - ( ) Los objetivos de la organización.

    > Debe alinearse con el puesto, los objetivos y los estándares definidos.

102. En la delimitación de la evaluación se debe tener en cuenta, entre otros aspectos:

    - ( ) Ninguno de los anteriores es relevante.
    - (x) Quién realizará la evaluación.
    - ( ) Cuándo se va a evaluar.
    - ( ) Qué se va a evaluar.

    > Definir el evaluador (quién) es una de las decisiones clave de la delimitación.

103. En relación con los criterios de evaluación, los objetivos frente a los subjetivos son:

    - (x) Las afirmaciones anteriores son incorrectas.
    - ( ) Siempre menos fiables.
    - ( ) Más difíciles de medir que los subjetivos.
    - ( ) Idénticos a los criterios de personalidad.

    > Los criterios objetivos se basan en resultados medibles; las afirmaciones previas son falsas.

104. La evaluación continua permite:

    - ( ) Detectar desviaciones a tiempo.
    - ( ) Corregir el rumbo antes del cierre del periodo.
    - (x) Todas las ventajas anteriores.
    - ( ) Ofrecer feedback frecuente.

    > Al ser frecuente, anticipa correcciones y aporta feedback continuo.

105. La evaluación del rendimiento orientada al futuro:

    - (x) Tiene en cuenta la mejora futura del rendimiento.
    - ( ) Solo sirve para justificar despidos.
    - ( ) Prescinde del desarrollo del empleado.
    - ( ) Se limita a registrar los resultados pasados.

    > El enfoque prospectivo persigue el desarrollo y la mejora futura.

106. Calificar sistemáticamente a los individuos de forma más desfavorable de lo que corresponde se denomina:

    - ( ) Error de halo.
    - ( ) Error de indulgencia.
    - (x) Error de severidad.
    - ( ) Error de proximidad.

    > El error de severidad es la tendencia a puntuar por debajo de lo merecido.

107. ¿Quién puede evaluar el rendimiento?

    - ( ) El propio trabajador (autoevaluación).
    - (x) Cualquiera de los anteriores, según el sistema.
    - ( ) Los compañeros y subordinados.
    - ( ) El superior inmediato.

    > La evaluación 360º integra superiores, pares, subordinados y autoevaluación.

108. La mejora del rendimiento implica:

    - ( ) Aportar feedback y apoyo al trabajador.
    - (x) Todas las acciones anteriores.
    - ( ) Establecer planes de acción concretos.
    - ( ) Identificar las causas del bajo desempeño.

    > Combina diagnóstico, feedback y planes de mejora.

109. Los criterios objetivos de evaluación pueden estar:

    - ( ) Basados solo en rasgos de personalidad.
    - ( ) Basados únicamente en el futuro.
    - ( ) Basados únicamente en el pasado.
    - (x) Basados tanto en el pasado como en el futuro.

    > Los criterios objetivos cubren resultados pasados y objetivos futuros.

110. Son componentes de la retribución financiera directa:

    - ( ) Los días de vacaciones.
    - (x) Los incentivos vinculados al desempeño.
    - ( ) El plan de carrera.
    - ( ) Los seguros médicos de empresa.

    > La retribución directa es dinero ligado al trabajo: salario base e incentivos.

111. Lograr una retribución justa mediante la comparación salarial entre los puestos de la propia organización se denomina:
    ...
    > Comparar puestos dentro de la empresa busca la equidad interna.

112. Son elementos de la estructura retributiva:

    - ( ) Los complementos e incentivos.
    - ( ) El salario base.
    - (x) Todos los elementos anteriores.
    - ( ) Las prestaciones y beneficios sociales.

    > La estructura combina base, complementos y prestaciones.

113. Son ejemplos de prestaciones económicas (retribución indirecta):

    - ( ) Las comisiones por ventas.
    - ( ) El salario base mensual.
    - ( ) Las horas extraordinarias.
    - (x) Los periodos sabáticos.

    > Las prestaciones son beneficios no salariales directos, como los periodos sabáticos.

114. Son componentes no financieros de la retribución:

    - ( ) Un buen clima y conciliación laboral.
    - ( ) El reconocimiento y la autonomía.
    - (x) Todos los anteriores.
    - ( ) Las oportunidades de desarrollo.

    > Lo no financiero abarca reconocimiento, desarrollo, clima y conciliación.

115. La retribución basada en el puesto de trabajo persigue lograr:

    - ( ) La equidad externa con el mercado.
    - (x) Las tres formas de equidad anteriores.
    - ( ) La equidad individual según contribución.
    - ( ) La equidad interna entre puestos.

    > Busca conjugar equidad interna, externa e individual.

116. En relación con la retribución basada en competencias, señale la respuesta incorrecta:

    - ( ) Se orienta a la persona más que al puesto.
    - (x) Requiere que los puestos estén muy estandarizados.
    - ( ) Premia los conocimientos y habilidades del trabajador.
    - ( ) Favorece la polivalencia y la flexibilidad.

    > La retribución por competencias encaja con entornos flexibles, no muy estandarizados; esa afirmación es falsa.

117. Los contratos blindados (de protección a directivos) también se denominan:

    - ( ) Retribución en especie.
    - (x) Paracaídas (golden parachutes).
    - ( ) Stock options.
    - ( ) Salario emocional.

    > Las cláusulas de blindaje se conocen como "paracaídas dorados".

118. "Los costes laborales incluyen tanto las prestaciones legales como las voluntarias."

    - (x) Verdadero
    - ( ) Falso

    > Los costes laborales comprenden las cargas legales y las prestaciones voluntarias de la empresa.

119. Son costes laborales para la empresa:

    - ( ) Las prestaciones voluntarias y beneficios.
    - ( ) Los salarios y complementos.
    - ( ) Las cotizaciones sociales obligatorias.
    - (x) Todos los conceptos anteriores.

    > El coste laboral total agrega salario, cotizaciones y beneficios.

120. Son incentivos que puede emplear la organización:

    - (x) Todos los tipos anteriores.
    - ( ) Incentivos de equipo o grupo.
    - ( ) Incentivos vinculados a resultados de la empresa.
    - ( ) Incentivos individuales por desempeño.

    > Los incentivos pueden ser individuales, grupales u organizativos.

121. En relación con el componente financiero de la retribución, señale la opción correcta:

    - ( ) Se limita a la retribución en especie.
    - (x) Las afirmaciones anteriores son incorrectas.
    - ( ) Incluye únicamente el salario base.
    - ( ) Excluye cualquier incentivo variable.

    > El componente financiero abarca directo e indirecto, fijo y variable; las opciones previas son falsas.

122. En relación con la retribución flexible, señale la respuesta incorrecta:

    - ( ) Tiene límites legales y de convenio.
    - ( ) Permite al trabajador elegir parte de su paquete retributivo.
    - (x) Se aplica sobre todo el salario, con independencia del convenio.
    - ( ) Puede incluir productos como seguro o formación.

    > La retribución flexible afecta a una parte del salario y está limitada por ley y convenio; lo contrario es falso.
