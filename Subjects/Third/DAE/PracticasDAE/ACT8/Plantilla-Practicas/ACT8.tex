...
\newcommand{\myDate}{3 de diciembre de 2024}
...
El reparto de roles entre los doce jurados queda resumido en la figura~\ref{fig:roles_jurado}.
\newpage
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[
        jurado/.style={draw, rounded corners=2pt, minimum width=32mm,
                       minimum height=13mm, align=center, font=\small},
        formal/.style={jurado, fill=black!12},
        informal/.style={jurado, fill=black!7},
        tareas/.style={jurado},
        socio/.style={jurado, densely dashed},
        disf/.style={jurado, dotted, thick},
        node distance=4mm and 5mm
    ]
        \node[formal]                       (j1)  {1 · Presidente\\\footnotesize Líder formal};
        \node[socio,  right=of j1]          (j2)  {2\\\footnotesize Socioemocional};
        \node[informal, right=of j2]        (j3)  {3\\\footnotesize Líder informal};

        \node[tareas, below=of j1]          (j4)  {4\\\footnotesize Especialista en tareas};
        \node[socio,  right=of j4]          (j5)  {5\\\footnotesize Socioemocional};
        \node[tareas, right=of j5]          (j6)  {6\\\footnotesize Especialista en tareas};

        \node[disf,   below=of j4]          (j7)  {7\\\footnotesize Disfuncional};
        \node[informal, right=of j7]        (j8)  {8\\\footnotesize Líder informal};
        \node[tareas, right=of j8]          (j9)  {9\\\footnotesize Especialista en tareas};

        \node[disf,   below=of j7]          (j10) {10\\\footnotesize Disfuncional};
        \node[tareas, right=of j10]         (j11) {11\\\footnotesize Especialista en tareas};
        \node[disf,   right=of j11]         (j12) {12\\\footnotesize Disfuncional};
    \end{tikzpicture}
    \caption{Roles identificados en el jurado de la película. El número es el del
    jurado según el orden de votación.}
