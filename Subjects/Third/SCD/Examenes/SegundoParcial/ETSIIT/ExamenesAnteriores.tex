...
Considerar el código del archivo disponible en la subsection de plantilla de este documento o \href{https://github.com/ElblogdeIsmael/ElblogdeIsmael.github.io/blob/main/Subjects/Third/SCD/Examenes/SegundoParcial/ETSIIT/code/ExamenCarlos/plantilla.cpp}{aquí}, que intenta plantear una solución al problema de la cena de los filósofos con camarero. Hay diversos errores en el código proporcionado que deberás solucionar:
\begin{enumerate}
...
La solución en código se encuentra \href{https://github.com/ElblogdeIsmael/ElblogdeIsmael.github.io/blob/main/Subjects/Third/SCD/Examenes/SegundoParcial/ETSIIT/code/ExamenCarlos/ejercicio.cpp}{aqui}.

\subsubsection*{Ejercicio 2}

En la resolución de este ejercicio usamos esta \href{https://github.com/ElblogdeIsmael/ElblogdeIsmael.github.io/blob/main/Subjects/Third/SCD/Examenes/SegundoParcial/ETSIIT/code/ExamenCarlos/prodcons2-muPlantilla.cpp}{(plantilla)}(pincha en plantilla para acceder a ella).
...
Pincha \href{https://github.com/ElblogdeIsmael/ElblogdeIsmael.github.io/blob/main/Subjects/Third/SCD/Examenes/SegundoParcial/ETSIIT/code/ExamenCarlos/prodcons2-mu.cpp}{aqui} para acceder al fichero.
...
\section{Materiales}
Los materiales se encuentran en mi página web (pincha \href{https://github.com/ElblogdeIsmael/ElblogdeIsmael.github.io/tree/main/Subjects/Third/SCD/Examenes/SegundoParcial/ETSIIT/code}{aqui}.)
