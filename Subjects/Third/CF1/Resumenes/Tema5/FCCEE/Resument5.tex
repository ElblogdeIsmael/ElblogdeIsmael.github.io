...
\subsection{Balance}
El inmovilizado material va en el activo no corriente, epígrafe II, y se presenta
por su \textbf{valor neto contable}: precio de adquisición menos la amortización
acumulada y menos el deterioro de valor. Las dos correcciones no aparecen como
partidas propias en el balance; se detallan en la memoria.

\subsection{Cuenta de Pérdidas y Ganancias}
Aparece en tres sitios. La \textbf{amortización del inmovilizado} es un gasto de
explotación con epígrafe propio. El \textbf{deterioro y el resultado por
enajenaciones} van juntos en otro epígrafe de explotación, y ahí el resultado de
la baja puede ser positivo o negativo. Las \textbf{subvenciones de capital} que
financiaron el activo se imputan al resultado en proporción a su amortización.
\subsection{Memoria}
...
El inmovilizado material toca los dos primeros bloques. En \textbf{actividades de
explotación} entra solo como ajuste del resultado, porque ni la amortización ni el
resultado por la baja mueven efectivo: la amortización se suma y el resultado por
enajenaciones se resta o se suma con el signo contrario al que llevaba en la cuenta
de pérdidas y ganancias. El efectivo de verdad va en \textbf{actividades de
inversión}: los pagos por la compra y los cobros por la venta, por su importe
cobrado o pagado, no por el valor contable.

\section{Cuestionario tipo test}
Para realizar el tipo test del libro pinche \href{https://elblogdeismael.github.io/Subjects/Third/CF1/Tests/testT5Libro.html}{aquí.}
