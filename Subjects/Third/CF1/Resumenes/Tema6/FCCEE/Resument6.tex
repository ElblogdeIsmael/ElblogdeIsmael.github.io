...
El tratamiento del inmovilizado intangible en las cuentas anuales sigue el mismo
esquema que el del inmovilizado material. En el balance aparece dentro del activo
no corriente, en el epígrafe A.I, y se desglosa por elementos: desarrollo,
concesiones, patentes y marcas, fondo de comercio, aplicaciones informáticas y
otro inmovilizado intangible. Cada uno figura por su valor neto contable, es
decir, el precio de adquisición menos la amortización acumulada y menos las
correcciones por deterioro.\\

En la cuenta de pérdidas y ganancias, la amortización del ejercicio y las
pérdidas por deterioro se llevan a resultados de explotación. La memoria completa
la información: recoge los criterios de amortización aplicados, el movimiento de
cada partida durante el ejercicio y las pruebas de deterioro del fondo de
comercio, que no se amortiza y hay que contrastar al menos una vez al año.


\section{Cuestionario tipo test}
Para realizar el tipo test del libro pinche \href{https://elblogdeismael.github.io/Subjects/Third/CF1/Tests/testT6Libro.html}{aquí.}
