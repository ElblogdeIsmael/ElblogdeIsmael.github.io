...
1. ¿Cuál es el propósito de un cortafuegos en una red?
    ...
    - (x) Filtrar y controlar el tráfico de red.
    - ( ) Aumentar la velocidad de la red.
    - ( ) Monitorear el uso de la electricidad.

    > Filtrar y controlar el tráfico de red es la función principal de un cortafuegos.
...
3. ¿Cuál de estas afirmaciones es cierta?
    ...
    > El orden en el que se definen las reglas del firewall en un router es importante.
...
4. ¿A qué se refiere la cadena INPUT a la hora de definir una regla para un firewall en el router?
    ...
    > Se refiere al tráfico (paquetes) que tienen como destino una de las IPs del router.

5. ¿Cuál de las siguientes afirmaciones sobre el protocolo OSPF es correcta?

    - ( ) OSPF utiliza el algoritmo de vector de distancia para determinar la mejor ruta.
    - (x) OSPF es un protocolo de enrutamiento de estado de enlace que utiliza el algoritmo Dijkstra.
    - ( ) OSPF no soporta la autenticación de los mensajes de enrutamiento.
    - ( ) OSPF es un protocolo de enrutamiento propietario de Cisco.

    > OSPF es un protocolo de enrutamiento de estado de enlace que utiliza el algoritmo Dijkstra.
...
6. A la hora de establecer una entrada en una tabla de encaminamiento de un router Mikrotik, ¿qué campos principales añadiría?
    ...
    > La dirección de red destino y la dirección del próximo salto.
...
7. Las acciones básicas que se pueden utilizar en el firewall de un router Mikrotik son:
    ...
    > Las acciones básicas que se pueden utilizar en el firewall de un router Mikrotik son reject, drop, accept.
...
8. Cuando un paquete IP llega a un router, ¿cómo sabe este hacia dónde reenviarlo?
    ...
    > Mediante la comparación de la dirección IP de destino con las entradas en la tabla de encaminamiento.
...
10. Asumiendo que el protocolo RIP está correctamente configurado en la red de datos de la isla X, ¿qué pasaría si se cae la interfaz eth1 con IP 33.X.2.1 de RX_2?
    ...
    > La red 33.X.2.0/24 dejaría de ser alcanzable desde cualquier interfaz externa a dicha red.
...
12. Considerando la topología de la red de datos del laboratorio, ¿qué lista de redes elegiría para configurar el protocolo RIP en RX_6 de la isla X?
    ...
    > 172.17.X.0/24 y 220.10.10.0/24.
...
14. Considerando la topología de la red de datos del laboratorio, ¿cuál de las siguientes configuraciones para la tabla de enrutamiento sería válida para que RX_4 supiera alcanzar cualquier interfaz dentro de su isla X?
    ...
    - ( ) <table> <tr> <th>Red de Destino</th> <th>Pasarela (gw)</th> </tr> <tr> <td>172.16.X.0/24</td> <td>ether1</td> </tr> <tr> <td>172.17.X.0/24</td> <td>ether2</td> </tr> <tr> <td>33.X.2.0/24</td> <td>172.16.X.2</td> </tr> <tr> <td>33.X.3.0/24</td> <td>172.16.X.3</td> </tr> <tr> <td>0.0.0.0</td> <td>172.17.X.4</td> </tr> </table> </label> <label>
    - ( ) <table> <tr> <th>Red de Destino</th> <th>Pasarela (gw)</th> </tr> <tr> <td>172.16.X.0/24</td> <td>ether1</td> </tr> <tr> <td>172.17.X.0/24</td> <td>ether2</td> </tr> <tr> <td>33.X.1.0/24</td> <td>172.16.X.1</td> </tr> <tr> <td>33.X.2.0/24</td> <td>172.16.X.2</td> </tr> <tr> <td>33.X.3.0/24</td> <td>172.16.X.3</td> </tr> <tr> <td>220.10.10.X/24</td> <td>172.17.X.4</td> </tr> </table> </label> <label>
    - (x) <table> <tr> <th>Red de Destino</th> <th>Pasarela (gw)</th> </tr> <tr> <td>172.16.X.0/24</td> <td>ether1</td> </tr> <tr> <td>172.17.X.0/24</td> <td>ether2</td> </tr> <tr> <td>33.X.1.0/24</td> <td>172.16.X.1</td> </tr> <tr> <td>33.X.2.0/24</td> <td>172.16.X.2</td> </tr> <tr> <td>33.X.3.0/24</td> <td>172.16.X.3</td> </tr> <tr> <td>220.10.10.X/24</td> <td>172.17.X.6</td> </tr> </table> </label>
