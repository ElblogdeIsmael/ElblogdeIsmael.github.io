...
\fancyhead[R]{Análisis de Operaciones Financieras}
...
\begin{titlepage}
    \begin{center}
        ...
        \Huge \textbf{Temario Análisis de Operaciones Financieras} 
        % \vspace{0.5cm}
        % \LARGE
...
\chapter{Mercado Monetario y Mercado de Capitales}

\input{Capitulos/tema2.tex}

\chapter{Resto de Temas}

\includepdf[pages=2-]{../ApuntesMD/Temario_Md.pdf}
