...
% Aquí había un \include con la ruta absoluta de mi máquina a un
% ARCHIVOS_LATEX/ que no existe ni existió en el repositorio. Un \include que
% no resuelve no rompe la compilación: LaTeX escribe «No file …» en el log y
% sigue, así que este documento llevaba publicándose sin ese índice y sin que
% nada lo dijera. Se quita: el PDF sale igual que hasta ahora.
...
\chapter{Resto de temas}

\includepdf[pages=2-]{Resumenes/Temario_Md.pdf}
