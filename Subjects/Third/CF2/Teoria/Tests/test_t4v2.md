# Test Contabilidad Financiera II

* **Autor:** Ismael Sallami Moreno
* **Titulación:** Ingeniería Informática + ADE

1. La financiación básica:
...
2. ¿Cuál es el desembolso mínimo legal exigido para las acciones de una Sociedad Anónima en su constitución, además del 100% de la prima de emisión si existiera?
...
4. ¿En qué apartado del Balance de Situación se presentan las "Acciones y participaciones en patrimonio propias"?
...
5. El Patrimonio Neto está conformado principalmente por:
...
6. La Reserva Legal en España debe dotarse con un 10% del beneficio del ejercicio hasta que esta alcance como mínimo el:
...
8. El artículo 79 del Texto Refundido de la Ley de Sociedades de Capital 1/2010, establece que las acciones de una Sociedad Anónima:
...
9. Cuando se conceden subvenciones para asegurar una rentabilidad mínima o compensar los déficits de explotación, ¿cómo se imputan?
...
10. Otros instrumentos de patrimonio neto son
...
11. Las subvenciones para adquirir activos del inmovilizado intangible, material e inversiones inmobiliarias se imputan:
...
12. La actividad de la empresa que origina variación de neto, ocasiona el nacimiento de un gasto o ingreso.
...
13. Las diferencias por ajustes de capital
...
14. ¿Cómo se imputan las subvenciones concedidas para financiar gastos específicos?
...
15. La cuenta (120) "Remanente" recoge:
...
16. En el proceso de constitución de una sociedad, antes de la inscripción registral, el capital emitido pero aún no inscrito se puede contabilizar en la cuenta:
...
17. Los importes monetarios recibidos sin asignación a una finalidad específica se imputan:
...
18. Las correcciones valorativas son
...
19. Las subvenciones concedidas a una empresa por organismos públicos deben contabilizarse:
...
20. Una subvención reintegrable es aquella que:
...
21. Cuando el valor de emisión de las acciones es mayor a su valor nominal, la diferencia entre ambos valores se recogerá en la cuenta de:
...
22. El patrimonio es igual al importe en X de todos los activos reconocidos menos el total de los importes en X de todos los pasivos reconocidos. X es:
...
23. La fundación simultánea considera:
...
24. ¿Cuál es el objetivo principal de imputar ciertos cambios de valor directamente al Patrimonio Neto en lugar de a la cuenta de Pérdidas y Ganancias?
...
25. Las subvenciones, donaciones y legados no reintegrables se contabilizarán inicialmente:
...
26. En el Estado de Cambios en el Patrimonio Neto (ECPN), la primera parte se denomina:
...
27. Los gastos puede llevar aparejados la constitución de la empresa son ...

    - (x) Notarios
    - (x) Gastos publicitarios
    - (x) Gastos extraordinarios

28. ¿Cómo define el Marco Conceptual del IASB el Patrimonio?
...
29. La reservas estatutarias son
...
30. Las aportaciones de socios o propietarios
...
32. Las reservas por capital amortizado
...
33. Cuando los socios o propietarios realicen aportaciones en su condición de tales y aumente el patrimonio neto de la empresa:
...
34. Las aportaciones realizadas por los socios a la empresa, que no corresponden a la suscripción de capital (ej. para compensar pérdidas), ¿cómo se consideran contablemente según la NRV 18.2?
...
37. Un "Dividendo activo a cuenta" (cuenta 557) representa:
...
38. La cuenta (121) "Resultados negativos de ejercicios anteriores" figura en el balance:
...
39. Los gastos de constitución de una sociedad, como los honorarios de notarios y registradores, se contabilizan generalmente:
...
40. El capital representa la financiación procedente de las aportaciones realizada por agentes externos a la empresa
...
41. Si un instrumento de patrimonio lo adquiere la propia empresa:
...
42. La cuantía del capital se hallará materializada como:
...
43. Si una empresa recibe una subvención para compensar un déficit de explotación, esta se contabilizará generalmente como:
...
44. Son reservas de Autofinanciación:
...
45. La financiación procedente de las aportaciones realizadas por los propietarios de la empresa, tanto en el momento en que ésta se formó como en fechas posteriores, se registrará en la cuenta:
...
46. ¿Qué significa emitir acciones "por encima de la par"?
...
47. La cuenta (100) "Capital Social" se utiliza principalmente para:
...
48. Si se producen beneficios estos se pueden:
...
49. La cuenta (1034) "Socios por desembolsos no exigidos, capital pendiente de inscripción" se utiliza para reflejar:
...
50. La suscripción y desembolso de las acciones:
...
51. Según la normativa española , la emisión de acciones "por debajo de la par":
...
52. El patrimonio es la parte residual de los activos de una entidad, una vez deducidos todos sus pasivos

    - (x) Verdadero
    - ( ) Falso

53. Una subvención no reintegrable es:
...
54. Las subvenciones, donaciones y legados recibidos por la empresa que están condicionados a la adquisición de un inmovilizado, generalmente se imputan a resultados:
...
55. El asiento que se debe de hacer para los resultados negativos que se tienen es:
...
56. Es obligatorio constituir la reserva lega.

    - (x) Verdadero.
    - ( ) Falso.

57. Las reservas por acciones propias aceptadas en garantía
...
58. Las subvenciones para cancelación de deudas se imputan:
...
59. La prima de emisión de acciones es
...
60. ¿Cómo se imputan las subvenciones para adquirir existencias o activos financieros?
...
61. Las reservas para acciones o participaciones de la sociedad dominante
...
62. Las subvenciones pueden clasificarse en:
