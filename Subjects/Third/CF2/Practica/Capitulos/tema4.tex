\hypertarget{relacion-de-ejercicios-propuestos-fondos-propios}{%
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6034}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8133}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0933}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
DEBE
...
\hypertarget{ejercicio-propuesto-2}{%
...
\hypertarget{ejercicio-propuesto-3}{%
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7160}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0733}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8467}}
...
\bottomrule\noalign{}
\endlastfoot
360.000,00 & 4708 H.P. Deudora por Subvenciones Concedidas &
40.000,00 \\
...
\bottomrule\noalign{}
\endlastfoot
40.000,00 & 172 Deudas a largo plazo transformables en subvenciones,
...
En caso de que las aportaciones no dinerarias sean inferiores al precio
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7634}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1183}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
DEBE
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7474}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1263}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
DEBE
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1358}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7284}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1358}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
DEBE
