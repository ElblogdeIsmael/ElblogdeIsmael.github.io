...
\input{Capitulos/Relacion1}

% Tema3 abre el capítulo con la idea de espacio de estados y el problema del
% mono y el plátano la desarrolla, así que van juntos y no en capítulos aparte.
\chapter{Búsqueda en espacios de estados}
\input{Capitulos/Tema3.tex}
\input{Capitulos/Problema_mono_plantano}



% Sin bibliografía: el texto no cita ninguna obra. La que había aquí se citaba a
% sí misma, con el autor del documento como única referencia.
