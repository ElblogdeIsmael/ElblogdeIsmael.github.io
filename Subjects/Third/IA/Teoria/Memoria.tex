...
\begin{titlepage}
  \begin{center}
    ...
    \begin{tikzpicture}[remember picture, overlay]
      \node[opacity=0.2] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{portada_parchis.png}};
...
\input{Capitulos/introduccion_memoria.tex}
\input{Capitulos/Cuerpo_memoria.tex}
\input{Capitulos/Conclusion_memoria.tex}
% \input{Capitulos/memoria2.tex}
