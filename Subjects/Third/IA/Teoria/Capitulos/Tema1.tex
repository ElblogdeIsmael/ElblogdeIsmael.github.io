...
Conviene definir la inteligencia artificial
...
Hay varias definiciones de IA, como pueden ser sistemas que actúan/piensan como humanos, o bien sistemas que actúan/piensas racionalmente. Una de ellas puede ser: "Campo de estudio que busca explicar y emular el comportamiento inteligente en términos de procesos computacionales"
...
Hay distintos softwares en los dispositivos que se relacionan con la acción de que \textit{piensan} debido a que usan inteligencia artifical, como es el caso de programas de ajedrez. ¿Es esto correcto? No se puede afirmar tal cosa, ya que según autores pensar es emular la mente humana, cosa que no es capaz de hacer la IA debido a que solo está entrenado para hacer las mejores jugadas, mientras que una persona piensa sobre otras temáticas y tiene cierto \textit{pensamiento libre}.

Al afirmar que piensan como humanos hay que tener en cuenta el \textit{pensamiento cognitivo}.
...
En esta asignatura se sigue la Teoría del Agente, que es la idea más aceptada hoy día y más usada. Este percibe el entorno y actúa de una manera específica. 
...
El origen del término de IA recae en John McCarthy. Los pioneros de la IA son varios, entre ellos Alan Turing, Marvin Minsky,...
...
En cuanto al recorrido de la IA a lo largo de la historia, destacan distintas épocas como es la Edad de Oro, Invierno de IA,...
